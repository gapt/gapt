...
public class HTDraw {
    ...
    void refreshScreenCoordinates() {
        refreshScreenCoordinates(new Dimension(view.getWidth(),view.getHeight()), view.getInsets());
    }
    void refreshScreenCoordinates(Dimension size, Insets insets) {
        sMax.x = (size.width- insets.left - insets.right) / 2;
        sMax.y = (size.height- insets.top - insets.bottom) / 2;
