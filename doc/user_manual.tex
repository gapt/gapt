...
ExpansionProofWithCut(List(),[p17] ETWeakQuantifier(∀x.∀y.(P(x,y)⊃P(s(x),y)), s(s(s(0))), p4, s(s(0)), p8, s(0), p12, 0, p16)
[p16] ETWeakQuantifier(∀y.(P(0,y)⊃P(s(0),y)), 0, p15)
[p15] ETImp(p13, p14)
[p14] ETAtom(P(s(0),0), false)
[p13] ETAtom(P(0,0), true)
[p12] ETWeakQuantifier(∀y.(P(s(0),y)⊃P(s(s(0)),y)), 0, p11)
[p11] ETImp(p9, p10)
[p10] ETAtom(P(s(s(0)),0), false)
[p9] ETAtom(P(s(0),0), true)
[p8] ETWeakQuantifier(∀y.(P(s(s(0)),y)⊃P(s(s(s(0))),y)), 0, p7)
[p7] ETImp(p5, p6)
[p6] ETAtom(P(s(s(s(0))),0), false)
[p5] ETAtom(P(s(s(0)),0), true)
[p4] ETWeakQuantifier(∀y.(P(s(s(s(0))),y)⊃P(s(s(s(s(0)))),y)), 0, p3)
[p3] ETImp(p1, p2)
[p2] ETAtom(P(s(s(s(s(0)))),0), false)
[p1] ETAtom(P(s(s(s(0))),0), true)
, [p1] ETAtom(P(0,0),...
\end{clilisting}
...
[p413] ∀x1.(f(x1)=0∨f(x1)=s(0)), ∀x1.∀y2.(<=(s(x1),y2)⊃<=(x1,y2)), ∀x1.∀y2.(<=(x1,M(x1,y2))∧<=(y2,M(x1,y2))) :- ∃x0.∃y1.(<=(s(x0),y1)∧f(x0)=f(y1))    (ContractionRightRule(p412, Suc(1), Suc(0)))
[p412] ∀x1.(f(x1)=0∨f(x1)=s(0)), ∀x1.∀y2.(<=(s(x1),y2)⊃<=(x1,y2)), ∀x1.∀y2.(<=(x1,M(x1,y2))∧<=(y2,M(x1,y2))) :- ∃x0.∃y1.(<=(s(x0),y1)∧f(x0)=f(y1)), ∃x0.∃y1.(<=(s(x0),y1)∧f(x0)=f(y1))    (ContractionLeftRule(p411, Ant(3), Ant(2)))
[p411] ∀x1.∀y2.(<=(s(x1),y2)⊃<=(x1,y2)), ∀x1.∀y2.(<=(x1,M(x1,y2))∧<=(y2,M(x1,y2))), ∀x1.(f(x1)=0∨f(x1)=s(0)), ∀x1.(f(x1)=0∨f(x1)=s(0)) :- ∃x0.∃y1.(<=(s(x0),y1)∧f(x0)=f(y1)), ∃x0.∃y1.(<=(s(x0),y1)∧f(x0)=f(y1))    (ContractionLeftRule(p410, Ant(4), Ant(2)))
[p410] ∀x1.∀y2.(<=(x1,M(x1,y2))∧<=(y2,M(x1,y2))), ∀x1.(f(x1)=0∨f(x1)=s(0)), ...
gapt> prooftool(acnf)

gapt> val et = LKToExpansionProof(acnf)
et: at.logic.gapt.proofs.expansion.ExpansionProofWithCut =
ExpansionProofWithCut(List(),[p19] ETWeakQuantifier(∀x1.(f(x1)=0∨f(x1)=s(0)), M(s(M(s(v100),v101)),v102), p3, M(s(M(s(s(M(s(v100),v101))),v1)),v102), p6, M(s(M(s(v100),v101)),s(M(s(M(s(v100),v101)),v102))), p9, M(s(s(M(s(v100),v101))),v1), p12, M(s(v100),v101), p15, M(s(M(s(s(M(s(v100),v101))),v1)),s(M(s(M(s(s(M(s(v100),v101))),v1)),v102))), p18)
[p18] ETOr(p16, p17)
[p17] ETAtom(f(M(s(M(s(s(M(s(v100),v101))),v1)),s(M(s(M(s(s(M(s(v100),v101))),v1)),v102))))=s(0), false)
[p16] ETAtom(f(M(s(M(s(s(M(s(v100),v101))),v1)),s(M(s(M(s(s(M(s(v100),v101))),v1)),v102))))=0, false)
[p15] ETOr(p13, p14)
[p14] ETAtom(f(M(s(v100),v101))=s(0), false)
[p13] ETAtom(f(M(s(v100),v101))=0, false)
[p12] ETOr(p10, p11)
[p11] ETAtom(f(M(s(s(M(s(v100),v...
gapt> prooftool(et)
