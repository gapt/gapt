...
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (CutRule(p1, Suc(0), p217, Ant(0)))
[p217] 0 = 0,
∀x_0 (f(x_0) = 0 ∨ f(x_0) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p216, Ant(2), Ant(3)))
[p216] ∀x_0 (f(x_0) = 0 ∨ f(x_0) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
0 = 0,
0 = 0
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p215, Suc(1), Suc(0)))
[p215] ∀x_0 (f(x_0) = 0 ∨ f(x_0) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
0 = 0,
0 = 0
⊢
∃x_0 ∃y_0 (s(x_0) <= y_0 ∧ f(x_0) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p214, Ant(3), A...
gapt> prooftool(acnf)

gapt> val et = LKToExpansionProof(acnf)
et: at.logic.gapt.proofs.expansion.ExpansionProofWithCut =
∀x_0 (f(x_0) = 0 ∨ f(x_0) = s(0))
  +^{M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_1)))}
    ((f(M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_1)))) = 0)- ∨
      (f(M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_1)))) = s(0))-)
  +^{M(s(M(s(y_1), s(y_1))), x_1)}
    ((f(M(s(M(s(y_1), s(y_1))), x_1)) = 0)- ∨
      (f(M(s(M(s(y_1), s(y_1))), x_1)) = s(0))-)
  +^{M(s(y_1), s(M(s(y_1), x_1)))}
    ((f(M(s(y_1), s(M(s(y_1), x_1)))) = 0)- ∨
      (f(M(s(y_1), s(M(s(y_1), x_1)))) = s(0))-)
  +^{M(s(y_1), s(y_1))}
