...
import at.logic.gapt.proofs.Context
 ...
 object ContextExample {
   ...
   ctx += hos" :- ∀n (n + 0 = n)" //Adding a theory axiom
...
c: Q(a): o
  ...
  at at.logic.gapt.proofs.gaptic.LemmaMacros$.finishProof(language.scala:47)
  ... 25 elided
\end{tacticsoutput}
...
∀x_0 ∀y (x_0 <= M(x_0, y) ∧ y <= M(x_0, y))
  +^{s(M(s(M(x_4, x_5)), s(M(x_4, x_5))))}
    (∀y (s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))) <=
            M(s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))), y) ∧
          y <= M(s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))), y))
      +^{s(M(s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))), x_6))}
        ((s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))) <=
            M(
            s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))),
            s(M(s(M(s(M(x_4, x_5)), s(M(x_4, x_5)))), x_6))))- ∧
...
P(0)
⊢
P(s(s(s(s(s(s(s(s(s(0))))))))))    (ForallLeftRule(p24, Ant(1), P(x1) ⊃ P(s(s(s(x1)))), s(s(s(s(s(s(0)))))), x1))
...
x_0 → s(s(s(s(s(s(s(s(s(s(s(s(x_1))))))))))))
...
back: at.logic.gapt.proofs.expansion.ExpansionProof => at.logic.gapt.proofs.expansion.ExpansionProof = at.logic.gapt.proofs.reduction.CombinedReduction$$Lambda$3814/1074556047@75e18f65
