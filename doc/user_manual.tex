...
[p24] ∀x.∀y.(P(s(x),y)⊃P(x,s(y))), ∀x.∀y.(P(s(x),y)⊃P(x,s(y))), P(s(s(s(s(s(0))))),0) :- P(0,s(s(s(s(s(0))))))    (ForallLeftRule(p23, Ant(0), ∀y.(P(s(x),y)⊃P(x,s(y))), 0, x))
[p23] ∀y.(P(s(0),y)⊃P(0,s(y))), ∀x.∀y.(P(s(x),y)⊃P(x,s(y))), P(s(s(s(s(s(0))))),0) :- P(0,s(s(s(s(s(0))))))    (ForallLeftRule(p22, Ant(0), (P(s(0),y)⊃P(0,s(y))), s(s(s(s(0)))), y))
[p22] (P(s(0),s(s(s(s(0)))))⊃P(0,s(s(s(s(s(0))))))), ∀x.∀y.(P(s(x),y)⊃P(x,s(y))), P(s(s(s(s(s(0))))),0) :- P(0,s(s(s(s(s(0))))))    (ImpLeftRule(p20, Suc(0), p21, Ant(0)))
[p21] P(0,s(s(s(s(s(0)))))) :- P(0,s(s(s(s(s(0))))))    (LogicalAxiom(P(0,s(s(s(s(s(0))))))))
[p20] ∀x...
\end{clilisting}
...
Some([p19] ∀x0.(p(x0)⊃p(s(x0))), p(0) :- p(s(s(0)))    (ContractionLeftRule(p18, Ant(2), Ant(1)))
[p18] p(0), ∀x0.(p(x0)⊃p(s(x0))), ∀x0.(p(x0)⊃p(s(x0))) :- p(s(s(0)))    (CutRule(p9, Suc(0), p17, Ant(1)))
[p17] ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (CutRule(p14, Suc(0), p16, Ant(0)))
[p16] p(s(s(0))) :- p(s(s(0)))    (ContractionRightRule(p15, Suc(0), Suc(1)))
[p15] p(s(s(0))) :- p(s(s(0))), p(s(s(0)))    (WeakeningRightRule(p10, p(s(s(0)))))
[p14] ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (ContractionLeftRule(p13, Ant(0), Ant(1)))
[p13] ∀x0.(p(x0)⊃p(s(x0))), ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (WeakeningLeftRule(p12, ∀x0.(p(x0)⊃p(s(x0)))))
[p12] ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (ForallLeftRule(p11, ...
gapt> Prover9 getExpansionProof sequent
res21: Option[at.logic.gapt.proofs.expansion.ExpansionProof] =
Some(ExpansionProofWithCut(List(),[p1] ETAtom(p(0), false)
, [p7] ETWeakQuantifier(∀x.(p(x)⊃p(s(x))), 0, p3, s(0), p6)
[p6] ETImp(p4, p5)
[p5] ETAtom(p(s(s(0))), false)
[p4] ETAtom(p(s(0)), true)
[p3] ETImp(p1, p2)
[p2] ETAtom(p(s(0)), false)
[p1] ETAtom(p(0), true)
 :- [p1] ETAtom(p(s(s(0))), true)
))
...
Some([p19] p(0), ∀x0.(p(x0)⊃p(s(x0))) :- p(s(s(0)))    (CutRule(p3, Suc(0), p18, Ant(1)))
[p18] ∀x0.(p(x0)⊃p(s(x0))), p(0) :- p(s(s(0)))    (ContractionLeftRule(p17, Ant(2), Ant(0)))
[p17] ∀x0.(p(x0)⊃p(s(x0))), p(0), ∀x0.(p(x0)⊃p(s(x0))) :- p(s(s(0)))    (CutRule(p8, Suc(0), p16, Ant(1)))
[p16] ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (CutRule(p13, Suc(0), p15, Ant(0)))
[p15] p(s(s(0))) :- p(s(s(0)))    (ContractionRightRule(p14, Suc(0), Suc(1)))
[p14] p(s(s(0))) :- p(s(s(0))), p(s(s(0)))    (WeakeningRightRule(p9, p(s(s(0)))))
[p13] ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (ContractionLeftRule(p12, Ant(0), Ant(1)))
[p12] ∀x0.(p(x0)⊃p(s(x0))), ∀x0.(p(x0)⊃p(s(x0))), p(s(0)) :- p(s(s(0)))    (WeakeningLeftRule(p11, ∀x0.(p(x0)⊃p(...
\end{clilisting}
...
gapt> Prover9 getExpansionProof strong
res23: Option[at.logic.gapt.proofs.expansion.ExpansionProof] =
Some(ExpansionProofWithCut(List(),[p3] ETSkolemQuantifier(∃x.∀y.P(x,y), s_{0}, p2)
[p2] ETWeakQuantifier(∀y.P(s_{0},y), s_{2}, p1)
[p1] ETAtom(P(s_{0},s_{2}), false)
 :- [p3] ETSkolemQuantifier(∀y.∃x.P(x,y), s_{2}, p2)
[p2] ETWeakQuantifier(∃x.P(x,s_{2}), s_{0}, p1)
[p1] ETAtom(P(s_{0},s_{2}), true)
))
...
res24: Option[at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula]] = Some(p(0), ((p(0)⊃p(s(0)))∧(p(s(0))⊃p(s(s(0))))) :- p(s(s(0))))
...
p: at.logic.gapt.proofs.lk.LKProof =
[p39] ∀x.∀y.(P(x,y)⊃P(x,s(y))), ∀x.∀y.(P(x,y)⊃P(s(x),y)), P(0,0) :- P(s(s(s(s(0)))),s(s(s(s(0)))))    (ContractionLeftRule(p38, Ant(0), Ant(1)))
[p38] ∀x.∀y.(P(x,y)⊃P(x,s(y))), ∀x.∀y.(P(x,y)⊃P(x,s(y))), ∀x.∀y.(P(x,y)⊃P(s(x),y)), P(0,0) :- P(s(s(s(s(0)))),s(s(s(s(0)))))    (ForallLeftRule(p37, Ant(0), ∀y.(P(x,y)⊃P(x,s(y))), s(s(s(s(0)))), x))
[p37] ∀y.(P(s(s(s(s(0)))),y)⊃P(s(s(s(s(0)))),s(y))), ∀x.∀y.(P(x,y)⊃P(x,s(y))), ∀x.∀y.(P(x,y)⊃P(s(x),y)), P(0,0) :- P(s(s(s(s(0)))),s(s(s(s(0)))))    (ForallLeftRule(p36, Ant(0), (P(s(s(s(s(0)))),y)⊃P(s(s(s(s(0)))),s(y))), s(s(s(0))), y))
[p36] (P(s(s(s(s(0)))),s(s(s(0))))⊃P(s(s(s(s(0)))),s(s(s(s(0)))))), ∀x.∀y.(P(x,y)⊃P(x,s(y))), ∀x.∀y.(P(x,y)⊃P(s(x),y)), P(0,0) :- P(s(s(s(s(0)))),s(s(s(s(0)))))    (ImpLeftRule(p...
...
[p12] ETImp(p10, p11)
[p11] ETAtom(P(s(s(s(s(0)))),s(s(s(s(0))))), false)
[p10] ETAtom(P(s(s(s(s(0)))),s(s(s(0)))), true)
[p9] ETImp(p7, p8)
[p8] ETAtom(P(s(s(s(s(0)))),s(s(s(0)))), false)
[p7] ETAtom(P(s(s(s(s(0)))),s(s(0))), true)
[p6] ETImp(p4, p5)
[p5] ETAtom(P(s(s(s(s(0)))),s(0)), false)
[p4] ETAtom(P(s(s(s(s(0)))),0), true)
[p3] ETImp(p1, p2)
[p2] ETAtom(P(s(s(s(s(0)))),s(s(0))), false)
[p1] ETAtom(P(s(s(s(s(0)))),s(0)), true)
, [p17] ETWeakQuantifier(∀x.∀y.(P(x,y)⊃P(s(x),y)), s(0), p4, 0, p8, s(s(0)), p12, s(s(s...
\end{clilisting}
...
[p403] ∀x1.∀y2.(<=(s(x1),y2)⊃<=(x1,y2)), ∀x1.(f(x1)=0∨f(x1)=s(0)), ∀x1.∀y2.(...
gapt> prooftool(acnf)
...
[p9] ETOr(p7, p8)
[p8] ETAtom(f(M(s(M(v100,s(M(v100,v101)...
gapt> prooftool(et)
...
p: at.logic.gapt.proofs.lk.LKProof =
[p16] ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(s(0)))))    (ContractionLeftRule(p15, Ant(0), Ant(1)))
[p15] ∀x.(P(x)⊃P(s(x))), ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(s(0)))))    (ForallLeftRule(p14, Ant(0), (P(x)⊃P(s(x))), s(s(s(0))), x))
[p14] (P(s(s(s(0))))⊃P(s(s(s(s(0)))))), ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(s(0)))))    (ImpLeftRule(p12, Suc(0), p13, Ant(0)))
[p13] P(s(s(s(s(0))))) :- P(s(s(s(s(0)))))    (LogicalAxiom(P(s(s(s(s(0)))))))
[p12] ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(0))))    (ContractionLeftRule(p11, Ant(0), Ant(1)))
[p11] ∀x.(P(x)⊃P(s(x))), ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(0))))    (ForallLeftRule(p10, Ant(0), (P(x)⊃P(s(x))), s(s(0)), x))
[p10] (P(s(s(0)))⊃P(s(s(s(0))))), ∀x.(P(x)⊃P(s(x))), P(0) :- P(s(s(s(0))))    (ImpLeftRule(p8, Suc(0), p9...
\end{clilisting}
