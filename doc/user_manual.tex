...
Some([p19] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(0): o :- p(s(s(0))): o    (ContractionLeftRule(p18, Ant(2), Ant(1)))
[p18] p(0): o, ∀x_0 (p(x_0) ⊃ p(s(x_0))), ∀x_0 (p(x_0) ⊃ p(s(x_0))) :- p(s(s(0))): o    (CutRule(p9, Suc(0), p17, Ant(1)))
[p17] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(s(0)): o :- p(s(s(0))): o    (CutRule(p14, Suc(0), p16, Ant(0)))
...
[p14] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(s(0)): o :- p(s(s(0))): o    (ContractionLeftRule(p13, Ant(0), Ant(1)))
[p13] ∀x_0 (p(x_0) ⊃ p(s(x_0))), ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(s(0)): o :- p(s(s(0))): o    (WeakeningLeftRule(p12, ∀x_0 (p(x_0) ⊃...
...
and Vampire (\cli{Vampire})\footnote{Unfortunately, we have to disable
  splitting in both SPASS and Vampire because we are unable to import proofs
  that contain splitting inferences.} as well, we will just show
...
Some([p19] p(0): o, ∀x_0 (p(x_0) ⊃ p(s(x_0))) :- p(s(s(0))): o    (CutRule(p3, Suc(0), p18, Ant(1)))
[p18] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(0): o :- p(s(s(0))): o    (ContractionLeftRule(p17, Ant(2), Ant(0)))
[p17] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(0): o, ∀x_0 (p(x_0) ⊃ p(s(x_0))) :- p(s(s(0))): o    (CutRule(p8, Suc(0), p16, Ant(1)))
[p16] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(s(0)): o :- p(s(s(0))): o    (CutRule(p13, Suc(0), p15, Ant(0)))
...
[p13] ∀x_0 (p(x_0) ⊃ p(s(x_0))), p(s(0)): o :- p(s(s(0))): o    (ContractionLeftRule(p12, Ant(0), Ant(1)))
[p12] ∀x_0 (p(x_0) ⊃ p(s(x_0))), ∀...
\end{clilisting}
