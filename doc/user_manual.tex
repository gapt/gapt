...
is no hole containing two pigeons. This is satisfiable iff $m\leq n$.\footnote{%
  In Scala, \cli{Sat4j isValid formula} is syntactical sugar for \cli{Sat4j.isValid(formula)}.}
\begin{clilisting}
...
List((the-proof,[p1003] F[1], PRIME-DIV, PRE, REM :-     (CutRule(p997, Suc(0), p1002, Ant(0)))
[p1002] INF(set_1(1)) :-     (DefinitionLeftRule(p1001, Ant(0), INF(set_1(1))))
[p1001] ∀m.∃n.∈((m+(n+1)),set_1(1)) :-     (ForallLeftRule(p1000, Ant(0), ∃n.∈((m+(n+1)),set_1(1)), 1, m))
[p1000] ∃n.∈((1+(n+1)),set_1(1)) :-     (ExistsLeftRule(p999, Ant(0), l_0, n))
[p999] ∈((1+(l_0+1)),set_1(1)) :-     (DefinitionLeftRule(p998, Ant(0), ∈((1+(l_0+1)),set_1(1))))
[p998] (1+(l_0+1))=1 :-     (TheoryAxiom((1+(l_0+1))=1 :- ))
[p997] F[1], PRIME-DIV, PRE, REM :- INF(set_1(1))    (CutRule(p6, Suc(0), p996, Ant(4)))
[p996] F[1], PRIME-DIV, PRE, REM, ¬empty(set_1(1)) :- INF(set_1(1))    (CutRule(p908, Suc(0), p995, Ant(0)))
[p995] O(set_1(1)...
gapt> val p = proofs(0)._2
p: at.logic.gapt.proofs.lkNew.LKProof =
[p1003] F[1], PRIME-DIV, PRE, REM :-     (CutRule(p997, Suc(0), p1002, Ant(0)))
[p1002] INF(set_1(1)) :-     (DefinitionLeftRule(p1001, Ant(0), INF(set_1(1))))
[p1001] ∀m.∃n.∈((m+(n+1)),set_1(1)) :-     (ForallLeftRule(p1000, Ant(0), ∃n.∈((m+(n+1)),set_1(1)), 1, m))
[p1000] ∃n.∈((1+(n+1)),set_1(1)) :-     (ExistsLeftRule(p999, Ant(0), l_0, n))
[p999] ∈((1+(l_0+1)),set_1(1)) :-     (DefinitionLeftRule(p998, Ant(0), ∈((1+(l_0+1)),set_1(1))))
...
[p997] F[1], PRIME-DIV, PRE, REM :- INF(set_1(1))    (CutRule(p6, Suc(0), p996, Ant(4)))
[p996] F[1], PRIME-DIV, PRE, REM, ¬empty(set_1(1)) :- INF(set_1(1))    (CutRule(p908, Suc(0), p995, Ant(0)))
[p995] O(set_1(1)), ¬empty(set_1(1)) :- INF(set_1(1)) ...
gapt> val q = skolemize( p )
q: at.logic.gapt.proofs.lkNew.LKProof =
[p968] F[1], PRIME-DIV, PRE, REM :-     (CutRule(p962, Suc(0), p967, Ant(0)))
[p967] INF(set_1(1)) :-     (DefinitionLeftRule(p966, Ant(0), INF(set_1(1))))
[p966] ∀m.∃n.∈((m+(n+1)),set_1(1)) :-     (ForallLeftRule(p965, Ant(0), ∃n.∈((m+(n+1)),set_1(1)), 1, m))
[p965] ∃n.∈((1+(n+1)),set_1(1)) :-     (ExistsLeftRule(p964, Ant(0), l_0, n))
[p964] ∈((1+(l_0+1)),set_1(1)) :-     (DefinitionLeftRule(p963, Ant(0), ∈((1+(l_0+1)),set_1(1))))
[p963] (1+(l_0+1))=1 :-     (TheoryAxiom((1+(l_0+1))=1 :- ))
[p962] F[1], PRIME-DIV, PRE, REM :- INF(set_1(1))    (CutRule(p6, Suc(0), p961, Ant(4)))
[p961] F[1], PRIME-DIV, PRE, REM, ¬empty(set_1(1)) :- INF(set_1(1))    (CutRule(p873, Suc(0), p960, Ant(0)))
[p960] O(set_1(1)), ¬empty(set_1(1)) :- INF(set_1(1))    (Cut...
\end{clilisting}
...
\subsection{Cut-elimination by resolution (CERES)}

\fxnote{Short example for first and higher-order CERES.}
...
VTRATGs and TRATGs (vectorial totally rigid acyclic tree grammars) are types of
tree grammars that have an intimate connection to proofs with
$\Pi_1$-cuts\cite{Hetzl14Algorithmic}.  GAPT contains an implementation of
these tree grammars, and given a finite tree language (a set of terms), is
automatically able to find a (V)TRATG that covers this language:
