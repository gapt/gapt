...
\end{tacticslisting}
\begin{tacticsoutput}
<console>:153: error: not found: value at
              import at.logic.gapt.expr._
                     ^
<console>:155: error: not found: value at
      import at.logic.gapt.proofs.gaptic._
             ^
<console>:154: error: not found: value at
      import at.logic.gapt.proofs.{Context, Sequent}
             ^
\end{tacticsoutput}
...
<console>:139: error: not found: value at
      help(at.logic.gapt.proofs.gaptic.TacticCommands)
           ^
...
gapt> val q = ReductiveCutElimination.eliminateInduction(p)(                                         examples.theories.nat.ctx)
q: gapt.proofs.lk.LKProof =
[p43] ∀x_1 ∀y_0 ((x_1:nat) + (s(y_0:nat): nat): nat) = s(x_1 + y_0),
∀x_1 x_1 + 0 = x_1
⊢
s(s(0)) + 0 = 0 + s(s(0))    (ContractionLeftRule(p42, Ant(1), Ant(2)))
[p42] ∀x_1 ((x_1:nat) + (0:nat): nat) = x_1,
∀x_1 ∀y_0 x_1 + s(y_0:nat) = s(x_1 + y_0),
∀x_1 ∀y_0 x_1 + s(y_0) = s(x_1 + y_0)
⊢
...
∀x_1 ∀y_0 x_1 + s(y_0) = s(x_1 + y_0)
⊢
s(s(0)) + 0 = 0 + s(s(0))    (ContractionLeftRule(p40, Ant(2), Ant(3)))
