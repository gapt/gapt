...
res34: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula] = ∀x ∀y (P(x, y) ⊃ Q(x, y)) :- ∃x ∃y (¬Q(x, y) ⊃ ¬P(x, y))

gapt> expansion.deep
res35: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula] =
...
res37: at.logic.gapt.proofs.expansion.ExpansionProof =
...
res45: at.logic.gapt.grammars.TratGrammar =
Axiom: x0
Non-terminals: x0, x1, x2
Productions:
  x0 -> s(x1)
