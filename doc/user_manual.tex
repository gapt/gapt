...
You can enter formulas as follows:
\begin{clilisting}
...
The prefix indicates the Scala type of the expression, available are the following:
...
The input language has full type inference---and in addition the formula
...
res11: at.logic.gapt.expr.HOLAtom = R(p_3, h_1): o
...
res15: Option[at.logic.gapt.models.Interpretation] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
sequent: at.logic.gapt.proofs.HOLSequent = p(0): o, ∀x (p(x) ⊃ p(s(x))) :- p(s(s(0))): o
...
res21: Option[at.logic.gapt.proofs.resolution.ResolutionProof] =
...
strong: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula] = ∃x ∀y P(x, y) :- ∀y ∃x P(x, y)
...
res26: Option[at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula]] = Some(p(0): o, (p(0) ⊃ p(s(0))) ∧ (p(s(0)) ⊃ p(s(s(0)))) :- p(s(s(0))): o)
...
[p12] Q(b, a): o :- ∃x ∃y (¬Q(x, y) ⊃ ¬P(x, y))    (ExistsRightRule(p11, Suc(0), ∃y (¬Q(x, y) ⊃ ¬P(x, y)), b, x))
[p11] Q(b, a): o :- ∃y (¬Q(b, y) ⊃ ¬P(b, y))    (ExistsRightRule(p10, Suc(0), ¬Q(b, y) ⊃ ¬P(b, y), a, y))
[p10] Q(b, a): o :- ¬Q(b, a) ⊃ ¬P(b, a)    (ImpRightRule(p9, Ant(0),...
\end{clilisting}
...
Pxy: at.logic.gapt.expr.FOLAtom = P(x, y): o
...
pa: at.logic.gapt.expr.FOLAtom = P(a): o

gapt> val pb = FOLAtom( "P", List( cb ) )
pb: at.logic.gapt.expr.FOLAtom = P(b): o
...
p: at.logic.gapt.proofs.lk.LKProof =
[p16] ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(s(0))))): o    (ContractionLeftRule(p15, Ant(0), Ant(1)))
[p15] ∀x (P(x) ⊃ P(s(x))), ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(s(0))))): o    (ForallLeftRule(p14, Ant(0), P(x) ⊃ P(s(x)), s(s(s(0))), x))
[p14] P(s(s(s(0)))) ⊃ P(s(s(s(s(0))))), ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(s(0))))): o    (ImpLeftRule(p12, Suc(0), p13, Ant(0)))
[p13] P(s(s(s(s(0))))): o :- P(s(s(s(s(0))))): o    (LogicalAxiom(P(s(s(s(s(0))))): o))
[p12] ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(0)))): o    (ContractionLeftRule(p11, Ant(0), Ant(1)))
[p11] ∀x (P(x) ⊃ P(s(x))), ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(0)))): o    (ForallLeftRule(p10, Ant(0), P(x) ⊃ P(s(x)), s(s(0)), x))
[p10] P(s(s(0))) ⊃ P(s(s(s(0)))), ∀x (P(x) ⊃ P(s(x))...
\end{clilisting}
...
End sequent: ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(s(0))))): o
Size of term set: 6
...
Productions:
  ...
  #v('τ': i) -> '-{∀x (P(x) ⊃ P(s(x)))}_a0'(#v('α_0': i))

  #v('τ': i) -> '-{∀x (P(x) ⊃ P(s(x)))}_a0'(s(#v('α_0': i)))

  #v('τ': i) -> '{P(s(s(s(s(0))))): o}_s0'
...
Some([p19] ∀x (P(x) ⊃ P(s(x))), P(0): o :- P(s(s(s(s(0))))): o    (CutRule(p10, Suc(0), p18, Ant(0)))
[p18] ∀'α_0' (P('α_0') ⊃ P(s(s('α_0')))), P(0): o :- P(s(s(s(s(0))))): o    (ContractionLeftRule(p17, Ant(1), Ant(0)))
[p17] ∀'α_0' (P('α_0') ⊃ P(s(s('α_0')))), ∀'α_0' (P('α_0') ⊃ P(s(s('α_0')))), P(0): o :- P(s(s(s(s(0))))): o    (ForallLeftRule(p16, Ant(2), P(#v('α_0': i)) ⊃ P(s(s(#v('α_0': i)))), s(s(0)), #v('α_0': i)))
[p16] ∀'α_0' (P('α_0') ⊃ P(s(s('α_0')))), P(0): o, P(s(s(0))) ⊃ P(s(s(s(s(0))))) :- P(s(s(s(s(0))))): o    (ForallLeftRule(p15, Ant(0), P(#v('α_0': i)) ⊃ P(s(s(#v('α_0': i)))), 0, #v('α_0': i)))
[p15] P(0) ⊃ P(s(s(0))), P(0): o, P(s(s(0))) ⊃ P(s(s(s(s(0))))) :- P(s(s(s(s(0))))): o    (ImpLeftRule(p11, Suc(0), p14, Ant(1)))
...
\end{clilisting}
...
Axiom: #v('τ': i)
Non-terminals: #v('τ': i), #v('α_1': i), #v('α_2': i)
Productions:
  #v('τ': i) -> s(#v('α_1': i))
  #v('τ': i) -> s(s(s(s(#v('α_1': i)))))
  #v('α_1': i) -> #v('α_2': i)
  #v('α_1': i) -> s(#v('α_2': i))
  #v('α_1': i) -> s(s(#v('α_2': i)))
  #v('α_2': i) -> 0
  #v('α_2': i) -> s(s(s(s(s(s(0))))))
  #v('α_2': i) -> s(s(s(s(s(s(s(s(s(s(s(s(0))))))))))))
...
res35: at.logic.gapt.grammars.TratGrammar =
Axiom: #v('τ': i)
Non-terminals: #v('τ': i), #v('α_1': i), #v('α_2': i)
Productions:
  #v('τ': i) -> s(#v('α_1': i))
...
[p21] ¬P(b, v) ∨ Q(b, v) :- ∃y (¬Q(b, y) ⊃ ¬P(b, y))    (ExistsRightRule(p20, Suc(0), ¬Q(b, y) ⊃ ¬P(b, y), v, y))
[p20] ¬P(b, v) ∨ Q(b, v) :- ¬Q(b, v) ⊃ ¬P(b, v)    (ImpRightRule(p19, Ant(1), Suc(0)))
[p19] ¬P(b, v) ∨ Q(b, v), ¬Q(b, v) :- ¬P(b, v)    (OrLeftRule(p16, Ant(0), p18...
\end{clilisting}
%
