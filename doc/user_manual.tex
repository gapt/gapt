...
[p533] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x_1 ∃y_0 (s(x_1) <= y_0 ∧ f(x_1) = f(y_0))    (ContractionRightRule(p532, Suc(1), Suc(0)))
[p532] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0)),
∃x_1 ∃y_0 (s(x_1) <= y_0 ∧ f(x_1) = f(y_0))    (ContractionLeftRule(p531, Ant(2), Ant(1)))
[p531] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0)),
∃x_1 ∃y_0 (s(x_1) <= y_0 ∧ f(x_1) = f(y_0))    (ContractionLeftRule(p530, Ant(2), Ant(0)))
[p530] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x...
gapt> prooftool(acnf)
  ...
  +^{M(
    ...
    ((f(M(
      ...
      (f(M(
            ...
            s(M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), x_5)))) =
        s(0))-)
  +^{M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), x_5)}
    ((f(M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), x_5)) = 0)- ∨
      (f(M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), x_5)) = s(0))-)
  +^{M(s(M(x_0, x)), s(M(x_0, x)))}
    ((f(M(s(M(x_0, x)), s(M(x_0, x)))) = 0)- ∨
      (f(M(s(M(x_0, x)), s(M(x_0, x)))) = s(0))-)
  +^...
gapt> prooftool(et)
