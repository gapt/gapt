...
[p230] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (CutRule(p1, Suc(0), p229, Ant(0)))
[p229] 0 = 0,
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p228, Ant(2), Ant(3)))
[p228] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
0 = 0,
0 = 0
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p227, Suc(1), Suc(0)))
[p227] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
0 = 0,
0 = 0
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p226, Ant(3), Ant(1))...
gapt> prooftool(acnf)

gapt> val et = LKToExpansionProof(acnf)
et: at.logic.gapt.proofs.expansion.ExpansionProofWithCut =
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
  +^{M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_2)))}
    ((f(M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_2)))) = 0)- ∨
      (f(M(s(M(s(y_1), s(y_1))), s(M(s(M(s(y_1), s(y_1))), x_2)))) = s(0))-)
  +^{M(s(M(s(y_1), s(y_1))), x_2)}
    ((f(M(s(M(s(y_1), s(y_1))), x_2)) = 0)- ∨
      (f(M(s(M(s(y_1), s(y_1))), x_2)) = s(0))-)
  +^{M(s(y_1), s(M(s(y_1), x_2)))}
    ((f(M(s(y_1), s(M(s(y_1), x_2)))) = 0)- ∨
      (f(M(s(y_1), s(M(s(y_1), x_2)))) = s(0))-)
  +^{M(s(y_1), s(y_1))}
    ((f(M(s(y_1), s(y_1))) = 0)- ∨ (f(M(s(y_1), s(y_1))) = s(0))-)
  +^{M(s(y_1), x_2)}
    ((f(M(s(y_1), x_2)) = 0)- ∨ (f(M(s(y_1), x_2)) = s(0))-)
