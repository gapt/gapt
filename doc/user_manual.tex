...
c: Q(a): o
  ...
  at at.logic.gapt.proofs.gaptic.LemmaMacros$.finishProof(language.scala:42)
  ... 25 elided
\end{tacticsoutput}
...
the tree grammar-based method described in~\cite{Eberhard15Inductive}. As of version 2.4 of GAPT,
viper is in an early stage of development. The tree grammar-based method is invoked as in:
\begin{lstlisting}
./viper.sh examples/induction/prod_prop_31.smt2
\end{lstlisting}
The analytic mode is invoked as in:
\begin{lstlisting}
./viper.sh aip examples/tip/isaplanner/prop_06.smt2
\end{lstlisting}
