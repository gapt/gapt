...
of the inference rules. For entering bigger proofs, it is more convenient to
use the ``gaptic'' tactics language, defined in section \ref{sec:gaptic}.

\subsubsection{Top-down proof construction}\label{sec:proofs-top-down}
...
\subsubsection{Creating a context}\label{sec:context-creation}
...
symbols:
\begin{clilisting}
gapt> implicit var ctx = Context.default
ctx: at.logic.gapt.proofs.Context =
...
gapt> ctx += Context.InductiveType("Nat", hoc" 0: Nat", hoc" s: Nat > Nat") //Adding a type declaration

gapt> ctx += hoc" '+' : Nat>Nat>Nat" //Adding a constant declaration

gapt> ctx += hos" :- ∀n (n + 0 = n)" //Adding a theory axiom

gapt> ctx += "1" -> le" s 0" //Adding a definition

gapt> ctx += hof" leq x y = (∃z x + z = y)" //Adding a definition as an equation
...
top-down construction presented in section \ref{sec:proofs-top-down},
gaptic allows a comfortable bottom-up development of proofs, similar
to popular proof assistants such as Coq, etc.
...
\subsubsection{Overview of tactics}\label{sec:gaptic-tactics-overview}
...
res20: at.logic.gapt.expr.HOLAtom = R(p_2, h_3): o
...
res24: Option[at.logic.gapt.proofs.drup.DrupProof] =
Some([derive]  ⊢
[derive] R(p_3, h_3) ⊢
[derive]  ⊢ R(p_4, h_1)
...
res26: Option[at.logic.gapt.models.Interpretation] =
Some(#v(a: o) -> false
#v(b: o) -> false
#v(c: o) -> true)
...
f: at.logic.gapt.expr.HOLFormula =
(#v(a: i) = #v(b: i) ∨ #v(a: i) = #v(c: i)) ∧
    #v(P: i>o)(#v(c: i)) ∧
    #v(P: i>o)(#v(b: i)) ⊃
  #v(P: i>o)(#v(a: i))
...
java.util.NoSuchElementException: key not found: #v(a: i)
  at scala.collection.MapLike$class.default(MapLike.scala:228)
  at scala.collection.AbstractMap.default(Map.scala:59)
  at scala.collection.MapLike$class.apply(MapLike.scala:141)
  at scala.collection.AbstractMap.apply(Map.scala:59)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:65)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:57)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:55)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:54)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:54)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:56)
  at at.logic.gapt.provers.smtlib.SmtlibSession.convert(SmtlibSession.scala:53)
  at at.logic.gapt.provers.smtlib.SmtlibSession.assert(SmtlibSession.scala:94)
  at at.logic.gapt.formats.verit.SmtLibExporter$$anonfun$apply$1$$anonfun$apply$4.apply(SmtLibExporter.scala:19)
  at at.logic.gapt.formats.verit.SmtLibExporter$$anonfun$apply$1$$anonfun$apply$4.apply(SmtLibExporter.scala:19)
  at scala.collection.immutable.List.foreach(List.scala:381)
  at at.logic.gapt.proofs.Sequent.foreach(sequents.scala:427)
  at at.logic.gapt.formats.verit.SmtLibExporter$$anonfun$apply$1.apply(SmtLibExporter.scala:19)
  at at.logic.gapt.formats.verit.SmtLibExporter$$anonfun$apply$1.apply(SmtLibExporter.scala:16)
  at at.logic.gapt.provers.IncrementalProvingSession$class.flatMap(provers.scala:152)
  at at.logic.gapt.provers.smtlib.SmtlibSession.flatMap(SmtlibSession.scala:13)
  at at.logic.gapt.provers.IncrementalProvingSession$class.map(provers.scala:151)
  at at.logic.gapt.provers.smtlib.SmtlibSession.map(SmtlibSession.scala:13)
  at at.logic.gapt.formats.verit.SmtLibExporter$.apply(SmtLibExporter.scala:16)
  ... 27 elided
...
∀x ∀y (x = y ⊃ y = x)
  +^{#v(a: i)}
    (∀y (#v(a: i) = y ⊃ y = #v(a: i))
      +^{#v(b: i)} ((#v(a: i) = #v(b: i))+ ⊃ (#v(b: i) = #v(a: i))-)
      +^{#v(c: i)} ((#v(a: i) = #v(c: i))+ ⊃ (#v(c: i) = #v(a: i))-)),
∀x1 ∀y1 (x1 = y1 ∧ #v(P: i>o)(x1) ⊃ #v(P: i>o)(y1))
  +^{#v(b: i)}
    (∀y1 (#v(b: i) = y1 ∧ #v(P: i>o)(#v(b: i)) ⊃ #v(P: i>o)(y1))
      +^{#v(a: i)}
        ((#v(b: i) = #v(a: i))+ ∧ #v(P: i>o)(#v(b: i))+ ⊃
          #v(P: i>o)(#v(a: i))-))
  +^{#v(c: i)}
    (∀y1 (#v(c: i) = y1 ∧ #v(P: i>o)(#v(c: i)) ⊃ #v(P: i>o)(y1))
      +^{#v(a: i)}
        ((#v(c: i) = #v(a: i))+ ∧ #v(P: i>o)(#v(c: i))+ ⊃
          #v(P: i>o)(#v(a: i))-))
:-
(((#v(a: i) = #v(b: i))- ∨ (#v(a: i) = #v(c: i))-) ∧ #v(P: i>o)(#v(c: i))-) ∧
   ...
gapt> extractInstances(expansionProof) foreach println
#v(a: i) = #v(c: i) ⊃ #v(c: i) = #v(a: i)
#v(a: i) = #v(b: i) ⊃ #v(b: i) = #v(a: i)
#v(c: i) = #v(a: i) ∧ #v(P: i>o)(#v(c: i)) ⊃ #v(P: i>o)(#v(a: i))
#v(b: i) = #v(a: i) ∧ #v(P: i>o)(#v(b: i)) ⊃ #v(P: i>o)(#v(a: i))
(#v(a: i) = #v(b: i) ∨ #v(a: i) = #v(c: i)) ∧
    #v(P: i>o)(#v(c: i)) ∧
    #v(P: i>o)(#v(b: i)) ⊃
  #v(P: i>o)(#v(a: i))
...
sequent: at.logic.gapt.proofs.HOLSequent =
#v(p: Nat>o)(0:Nat),
∀x (#v(p: Nat>o)(x:Nat) ⊃ #v(p: Nat>o)(s(x): Nat))
⊢
#v(p: Nat>o)(s(s(0)))
...
scala.MatchError: f1(f2(f2(f0:Nat): Nat)): o (of class at.logic.gapt.expr.determineTraits$App_with_HOLAtom)
  at at.logic.gapt.provers.prover9.Prover9.at$logic$gapt$provers$prover9$Prover9$$toP9Input(prover9.scala:67)
  at at.logic.gapt.provers.prover9.Prover9.at$logic$gapt$provers$prover9$Prover9$$toP9Input(prover9.scala:70)
  at at.logic.gapt.provers.prover9.Prover9.at$logic$gapt$provers$prover9$Prover9$$toP9Input(prover9.scala:66)
  at at.logic.gapt.provers.prover9.Prover9$$anonfun$at$logic$gapt$provers$prover9$Prover9$$toP9Input$1.apply(prover9.scala:55)
  at at.logic.gapt.provers.prover9.Prover9$$anonfun$at$logic$gapt$provers$prover9$Prover9$$toP9Input$1.apply(prover9.scala:55)
  ...
  at at.logic.gapt.provers.prover9.Prover9.at$logic$gapt$provers$prover9$Prover9$$toP9Input(prover9.scala:55)
  at at.logic.gapt.provers.prover9.Prover9$$anonfun$getResolutionProof$1.apply(prover9.scala:25)
  at at.logic.gapt.provers.prover9.Prover9$$anonfun$getResolutionProof$1.apply(prover9.scala:24)
  at at.logic.gapt.provers.renameConstantsToFi$.wrap(utils.scala:20)
  at at.logic.gapt.provers.prover9.Prover9.getResolutionProof(prover9.scala:23)
  at at.logic.gapt.provers.ResolutionProver$class.getResolutionProof(ResolutionProver.scala:27)
  at at.logic.gapt.provers.prover9.Prover9.getResolutionProof(prover9.scala:21)
  at at.logic.gapt.provers.ResolutionProver$class.getResolutionProof(ResolutionProver.scala:42)
  at at.logic.gapt.provers.prover9.Prover9.getResolutionProof(prover9.scala:21)
  at at.logic.gapt.provers.ResolutionProver$class.isValid(ResolutionProver.scala:23)
  at at.logic.gapt.provers.prover9.Prover9.isValid(prover9.scala:21)
  ... 27 elided
...
scala.MatchError: f1(f2(f2(f0:Nat): Nat)): o (of class at.logic.gapt.expr.determineTraits$App_with_HOLAtom)
  ...
  at at.logic.gapt.provers.ResolutionProver$class.getResolutionProof(ResolutionProver.scala:42)
  at at.logic.gapt.provers.prover9.Prover9.getResolutionProof(prover9.scala:21)
  at at.logic.gapt.provers.ResolutionProver$$anonfun$getLKProof$1.apply(ResolutionProver.scala:15)
  at at.logic.gapt.provers.ResolutionProver$$anonfun$getLKProof$1.apply(ResolutionProver.scala:14)
  at at.logic.gapt.provers.groundFreeVariables$.wrap(utils.scala:43)
  at at.logic.gapt.provers.ResolutionProver$class.getLKProof(ResolutionProver.scala:14)
  at at.logic.gapt.provers.prover9.Prover9.getLKProof(prover9.scala:21)
  at at.logic.gapt.provers.ResolutionProver$class.getLKProof(ResolutionProver.scala:11)
  at at.logic.gapt.provers.prover9.Prover9.getLKProof(prover9.scala:21)
  ... 27 elided
...
scala.MatchError: f1(f2(f2(f0:Nat): Nat)): o (of class at.logic.gapt.expr.determineTraits$App_with_HOLAtom)
  ...
  at at.logic.gapt.provers.ResolutionProver$class.getResolutionProof(ResolutionProver.scala:42)
  at at.logic.gapt.provers.prover9.Prover9.getResolutionProof(prover9.scala:21)
  at at.logic.gapt.provers.ResolutionProver$$anonfun$getExpansionProof$1.apply(ResolutionProver.scala:49)
  at at.logic.gapt.provers.ResolutionProver$$anonfun$getExpansionProof$1.apply(ResolutionProver.scala:48)
  at at.logic.gapt.provers.groundFreeVariables$.wrap(utils.scala:43)
  at at.logic.gapt.provers.ResolutionProver$class.getExpansionProof(ResolutionProver.scala:48)
  at at.logic.gapt.provers.prover9.Prover9.getExpansionProof(prover9.scala:21)
  ... 27 elided
...
res35: Option[at.logic.gapt.proofs.lk.LKProof] = None
...
java.lang.IllegalArgumentException: requirement failed
  ...
  at at.logic.gapt.expr.hol.SkolemFunctions$$anonfun$1.apply(SkolemFunctions.scala:24)
  at at.logic.gapt.expr.hol.SkolemFunctions$$anonfun$1.apply(SkolemFunctions.scala:21)
  at scala.collection.immutable.Map$Map2.foreach(Map.scala:137)
  at at.logic.gapt.expr.hol.SkolemFunctions.<init>(SkolemFunctions.scala:21)
  at at.logic.gapt.expr.hol.SkolemFunctions$.apply(SkolemFunctions.scala:46)
  at at.logic.gapt.proofs.expansion.ExpansionProof.<init>(expansionProofs.scala:34)
  at at.logic.gapt.proofs.expansion.replaceET$.apply(expansionTrees.scala:377)
  at at.logic.gapt.proofs.expansion.package$expansionProofsAreReplaceable$.replace(package.scala:42)
  at at.logic.gapt.proofs.expansion.package$expansionProofsAreReplaceable$.replace(package.scala:41)
  at at.logic.gapt.expr.TermReplacement$.apply(TermReplacement.scala:136)
  at at.logic.gapt.expr.TermReplacement$.hygienic(TermReplacement.scala:152)
  at at.logic.gapt.provers.groundFreeVariables$$anonfun$wrap$2.apply(utils.scala:43)
  at scala.Option.map(Option.scala:146)
  at at.logic.gapt.provers.groundFreeVariables$.wrap(utils.scala:43)
  at at.logic.gapt.provers.ResolutionProver$class.getExpansionProof(ResolutionProver.scala:48)
  at at.logic.gapt.provers.prover9.Prover9.getExpansionProof(prover9.scala:21)
  at at.logic.gapt.provers.Prover$class.getExpansionProof(provers.scala:63)
  at at.logic.gapt.provers.prover9.Prover9.getExpansionProof(prover9.scala:21)
  ... 27 elided
...
java.lang.IllegalArgumentException: requirement failed: Sequent #v(p: Nat>o)(0:Nat),
∀x (#v(p: Nat>o)(x:Nat) ⊃ #v(p: Nat>o)(s(x): Nat))
⊢
#v(p: Nat>o)(s(s(0))) is not ground!
  at scala.Predef$.require(Predef.scala:224)
  at at.logic.gapt.formats.tptp.TPTPFOLExporter$.apply(TPTPFOLExporter.scala:12)
  ... 27 elided
...
gapt> tptp.toSequent
res39: at.logic.gapt.proofs.HOLSequent =
i(sr2),
¬i(two),
times(sr2, sr2) = two,
...
java.lang.IllegalArgumentException: Formula ∀x ∀y ∀z (x + y + (z:Nat): Nat) = x + (y + z) ∧ ∀x ∀y x + y = y + x ⊃
  #v(d: Nat) + #v(a: Nat) + #v(c: Nat) + #v(b: Nat) =
    #v(a: Nat) + #v(b: Nat) + #v(c: Nat) + #v(d: Nat) appears not to be a FOL formula. Parse it with hof.
  at at.logic.gapt.expr.ExpressionParseHelper.fof(ExpressionParseHelper.scala:147)
  ... 27 elided

gapt> Escargot getResolutionProof formula
<console>:127: error: not found: value formula
      Escargot getResolutionProof formula
                                  ^
...
[p5]  ⊢ #v(a: o) ⊃ #v(b: o) ⊃ #v(a: o) ∧ #v(b: o)    (ImpRightRule(p4, Ant(0), Suc(0)))
[p4] #v(a: o) ⊢ #v(b: o) ⊃ #v(a: o) ∧ #v(b: o)    (ImpRightRule(p3, Ant(1), Suc(0)))
[p3] #v(a: o), #v(b: o) ⊢ #v(a: o) ∧ #v(b: o)    (AndRightRule(p1, Suc(0), p2, Suc(0)))
[p2] #v(b: o) ⊢ #v(b: o)    (LogicalAxiom(#v(b: o)))
[p1] #v(a: o) ⊢ #v(a: o)    (LogicalAxiom(#v(a: o)))
...
[p9]
⊢
#v(a: i) = #v(b: i) ∧ #v(f: i>i)(#v(a: i)) = #v(b: i) ⊃
  #v(a: i) = #v(f: i>i)(#v(f: i>i)(#v(b: i)))    (ImpRightRule(p8, Ant(0), Suc(0)))
[p8] #v(a: i) = #v(b: i) ∧ #v(f: i>i)(#v(a: i)) = #v(b: i)
⊢
#v(a: i) = #v(f: i>i)(#v(f: i>i)(#v(b: i)))    (AndLeftRule(p7, Ant(1), Ant(0)))
[p7] #v(f: i>i)(#v(a: i)) = #v(b: i),
#v(a: i) = #v(b: i)
⊢
#v(a: i) = #v(f: i>i)(#v(f: i>i)(#v(b: i)))    (EqualityLeftRule(p6, Ant(0), Ant(1), λx #v(f: i>i)(#v(a: i)) = x))
[p6] #v(a: i) = #v(b: i),
#v(f: i>i)(#v(a: i)) = #v(a: i)
⊢
#v(a: i) = #v(f: i>i)(#v(f: i>i)(#v(b: i)))    (EqualityRightRule(p5, Ant(0), Suc(0), λx #v(a: i) = #v(f: i>i)(#v(f: i>i)(x))))
[p5] #v(a: i) = #v(b: i),
#v(f: i>i)(#v(a: i)) = #v(a: i)
⊢
#v(a: i) = #v(f: i>i)(#v(f: i>i)(#v(a: i))) ...
\end{clilisting}
...
p: at.logic.gapt.proofs.lk.LKProof =
[p1] #v(P: i>i>o)(x, y) ⊢ #v(P: i>i>o)(x, y)    (LogicalAxiom(#v(P: i>i>o)(x, y): o))

gapt> p = ExistsRightRule(p, hof"?x P(x,y)", le"x")
p: at.logic.gapt.proofs.lk.LKProof = [p2] #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ExistsRightRule(p1, Suc(0), #v(P: i>i>o)(x, y): o, x, x))
[p1] #v(P: i>i>o)(x, y) ⊢ #v(P: i>i>o)(x, y)    (LogicalAxiom(#v(P: i>i>o)(x, y): o))

gapt> p = ForallLeftRule(p, hof"!y P(x,y)", le"y")
p: at.logic.gapt.proofs.lk.LKProof = [p3] ∀y #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ForallLeftRule(p2, Ant(0), #v(P: i>i>o)(x, y): o, y, y))
[p2] #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ExistsRightRule(p1, Suc(0), #v(P: i>i>o)(x, y): o, x, x))
[p1] #v(P: i>i>o)(x, y) ⊢ #v(P: i>i>o)(x, y)    (LogicalAxiom(#v(P: i>i>o)(x, y): o))

gapt> p = ForallRightRule(p, hof"!y?x P(x,y)", fov"y")
p: at.logic.gapt.proofs.lk.LKProof = [p4] ∀y #v(P: i>i>o)(x, y) ⊢ ∀y ∃x #v(P: i>i>o)(x, y)    (ForallRightRule(p3, Suc(0), y, y))
[p3] ∀y #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ForallLeftRule(p2, Ant(0), #v(P: i>i>o)(x, y): o, y, y))
[p2] #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ExistsRightRule(p1, Suc(0), #v(P: i>i>o)(x, y): o, x, x))
[p1] #v(P: i>i>o)(x, y) ⊢ #v(P: i>i>o)(x, y)    (LogicalAxiom(#v(P: i>i>o)(x, y): o))

gapt> p = ExistsLeftRule(p, hof"?x!y P(x,y)", fov"x")
p: at.logic.gapt.proofs.lk.LKProof = [p5] ∃x ∀y #v(P: i>i>o)(x, y) ⊢ ∀y ∃x #v(P: i>i>o)(x, y)    (ExistsLeftRule(p4, Ant(0), x, x))
[p4] ∀y #v(P: i>i>o)(x, y) ⊢ ∀y ∃x #v(P: i>i>o)(x, y)    (ForallRightRule(p3, Suc(0), y, y))
[p3] ∀y #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ForallLeftRule(p2, Ant(0), #v(P: i>i>o)(x, y): o, y, y))
[p2] #v(P: i>i>o)(x, y) ⊢ ∃x #v(P: i>i>o)(x, y)    (ExistsRightRule(p1, Suc(0), #v(P: i>i>o)(x, y): o, x, x))
[p1] #v(P: i>i>o)(x, y) ⊢ #v(P: i>i>o)(x, y)    (LogicalAxiom(#v(P: i>i>o)(x, y): o))
...
q: at.logic.gapt.proofs.lk.LKProof =
[p3] ∀y #v(P: i>i>o)(s_0, y) ⊢ ∃x #v(P: i>i>o)(x, s_1)    (ForallLeftRule(p2, Ant(0), #v(P: i>i>o)(s_0, y): o, s_1, y))
[p2] #v(P: i>i>o)(s_0, s_1) ⊢ ∃x #v(P: i>i>o)(x, s_1)    (ExistsRightRule(p1, Suc(0), #v(P: i>i>o)(x, s_1): o, s_0, x))
[p1] #v(P: i>i>o)(s_0, s_1) ⊢ #v(P: i>i>o)(s_0, s_1)    (LogicalAxiom(#v(P: i>i>o)(s_0, s_1): o))
...
java.lang.IllegalArgumentException: Formula #v(P: i>o)(#v(a: i)): o appears not to be a FOL formula. Parse it with hof.
  at at.logic.gapt.expr.ExpressionParseHelper.fof(ExpressionParseHelper.scala:147)
  ... 27 elided

gapt> val axpb = LogicalAxiom( fof"P(b)" )
java.lang.IllegalArgumentException: Formula #v(P: i>o)(#v(b: i)): o appears not to be a FOL formula. Parse it with hof.
  at at.logic.gapt.expr.ExpressionParseHelper.fof(ExpressionParseHelper.scala:147)
  ... 27 elided

gapt> val proof = WeakeningLeftRule( axpa, fof"a=b" )
<console>:126: error: not found: value axpa
      val proof = WeakeningLeftRule( axpa, fof"a=b" )
                                     ^

gapt> val pr = EqualityRightRule( proof, fof"a=b", Suc( 0 ), fof"P(b)" )
<console>:126: error: not found: value proof
      val pr = EqualityRightRule( proof, fof"a=b", Suc( 0 ), fof"P(b)" )
                                  ^
...
<console>:126: error: not found: value pr
      val I = ExtractInterpolant( pr, Seq( Suc( 0 ) ), Seq( Ant( 0 ), Ant( 1 ) ) )
                                  ^
...
res43: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula] = ∀x ∀y (P(x, y) ⊃ Q(x, y)) ⊢ ∃x ∃y (¬Q(x, y) ⊃ ¬P(x, y))

gapt> expansion.deep
res44: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula] =
...
res46: at.logic.gapt.proofs.expansion.ExpansionProof =
∀x ∀y (P(x, y) ⊃ Q(x, y))
...
res47: at.logic.gapt.proofs.lk.LKProof =
...
[p253] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p252, Suc(1), Suc(0)))
[p252] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
⊢
∃x_0 ∃y_0 (s(x_0) <= y_0 ∧ f(x_0) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p251, Ant(2), Ant(1)))
[p251] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_0 ∀y (x_0 <= M(x_0, y) ∧ y <= M(x_0, y)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
⊢
∃x_0 ∃y_0 (s(x_0) <= y_0 ∧ f(x_0) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p250, Ant(3), Ant(0)))
[p250] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_0 ∀y (x_0 <= M(x_0, y) ∧ y <= M(x_0, y)),
∀x_1 ∀y (x_1 <=...
gapt> prooftool(acnf)
...
∀x_0 ∀y (x_0 <= M(x_0, y) ∧ y <= M(x_0, y))
  +^{s(M(s(M(x_3, x_4)), s(M(x_3, x_4))))}
    (∀y (s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))) <=
            M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), y) ∧
          y <= M(s(M(s(M(x_3, x_4)), s(M(x_3, x_4)))), y))
...
java.lang.IllegalArgumentException: Parse error at <console>:126:
Cannot type-check (((P:_6f1) ((((cons:_24c) ((0:_121):nat)) (((cons:_dfa) ((s:_22c) (0:_4b6))) (nil:_48a))):list)):o):
Cannot unify types Nat and nat in
_387 = _6f1
_204 = _24c
_121 = Nat
Nat = nat

  at at.logic.gapt.expr.ExpressionParseHelper.interpolate(ExpressionParseHelper.scala:59)
  at at.logic.gapt.expr.ExpressionParseHelper.hof(ExpressionParseHelper.scala:80)
  ... 27 elided

gapt> val axiom = hof"P(nil) & !x!y!z (P(x) -> P(cons(y: nat, cons(z, x)): list))"
axiom: at.logic.gapt.expr.HOLFormula =
#v(P: list>o)(#v(nil: list)) ∧
  ∀x ∀y ∀z (#v(P: list>o)(x:list) ⊃
      #v(P: list>o)(#v(cons: nat>list>list)(
            y:nat,
            #v(cons: nat>list>list)(z:nat, x): list):
          list))

gapt> val problem = hof"$axiom -> $formula"
<console>:127: error: not found: value formula
      val problem = hof"$axiom -> $formula"
                                   ^
...
<console>:127: error: not found: value problem
      Escargot.getExpansionProof(problem)
                                 ^
...
<console>:127: error: not found: value firstOrderProblem
      Prover9 getExpansionProof firstOrderProblem map back
                                ^
<console>:127: error: not found: value back
      Prover9 getExpansionProof firstOrderProblem map back
                                                      ^
