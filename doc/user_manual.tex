...
expansionSequent: at.logic.gapt.proofs.expansion.ExpansionSequent =
...
warning: there was one deprecation warning; re-run with -deprecation for details
res21: Option[at.logic.gapt.proofs.expansion.ExpansionSequent] =
Some([p1] ETAtom(p(0), false)
...
warning: there was one deprecation warning; re-run with -deprecation for details
res23: Option[at.logic.gapt.proofs.expansion.ExpansionSequent] =
Some([p3] ETSkolemQuantifier(∃x.∀y.P(x,y), s_{0}, p2)
