...
[p495] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x ∀y (s(x) <= y ⊃ x <= y)
:-
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p494, Suc(1), Suc(0)))
[p494] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x ∀y (s(x) <= y ⊃ x <= y)
:-
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p493, Ant(3), Ant(2)))
[p493] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x ∀y (s(x) <= y ⊃ x <= y),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
:-
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p492, Ant(4), Ant(1)))
[p492] ∀x ∀y (s(x) <= y ⊃ x...
gapt> prooftool(acnf)
