...
\begin{clilisting}
gapt> val tptp = TptpParser.load("examples/import/irrationals.p")
...
[p436] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
:-
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p435, Suc(1), Suc(0)))
[p435] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
:-
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p434, Ant(2), Ant(1)))
[p434] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
:-
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p433, Ant(3), Ant(0)))
[p433] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 ∀y (x_1 <= M(x_1, y...
gapt> prooftool(acnf)
...
∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y))
  +^{s(M(s(M(v100, v101)), s(M(v100, v101))))}
    (∀y (s(M(s(M(v100, v101)), s(M(v100, v101)))) <=
            M(s(M(s(M(v100, v101)), s(M(v100, v101)))), y) ∧
          y <= M(s(M(s(M(v100, v101)), s(M(v100, v101)))), y))
      +^{s(M(s(M(s(M(v100, v101)), s(M(v100, v101)))), s(M(v100, v101))))}
        ((s(M(s(M(v100, v101)), s(M(v100, v101)))) <=
            M(
            s(M(s(M(v100, v101)), s(M(v100, v101)))),
            s(M(s(M(s(M(v100, v101)), s(M(v100, v101)))), s(M(v100, v101))))))- ∧
