...
res22: Option[at.logic.gapt.models.PropositionalModel] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
res40: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.Formula] = ∀X (X ⊃ X), ∀x ∀y (P(x, y) ⊃ Q(x, y)) ⊢ ∃x ∃y (¬Q(x, y) ⊃ ¬P(x, y))
