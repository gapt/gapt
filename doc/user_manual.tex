...
\begin{clilisting}
gapt> val Some(witness) = wscan.witness(derivation, witnessLimit=Some(1)): @unchecked
val witness: gapt.expr.subst.Substitution = Substitution(X:i>o -> λu_0 c != u_0 ∨ b = u_0)

\end{clilisting}
During the construction of the witness some saturation processes doing inference steps similar to SCAN have to run. 
...
Passing \texttt{oneSidedOnly=true} when running SCAN ensures that a limit of \texttt{Some(1)} will suffice.
...
\begin{clilisting}
gapt> val Some((derivation, witness)) = wscan(clauseSetPep, oneSidedOnly=true, derivationLimit=Some(10), attemptLimit=Some(10), witnessLimit=Some(1)): @unchecked
val derivation: gapt.logic.hol.scan.Derivation = Derivation(ClauseSetPredicateEliminationProblem(Set(X:i>o),Set( ⊢ X(b), X(c) ⊢ ,  ⊢ X(a))),List(ConstraintResolution(PointedClause( ⊢ X(b),Suc(0)),PointedClause(X(c) ⊢ ,Ant(0))), PurifiedClauseDeletion(PointedClause( ⊢ X(b),Suc(0))), ConstraintResolution(PointedClause(X(c) ⊢ ,Ant(0)),PointedClause( ⊢ X(a),Suc(0))), PurifiedClauseDeletion(PointedClause(X(c) ⊢ ,Ant(0))), ExtendendPurityDeletion(X:i>o,Positive)))
val witness: gapt.expr.subst.Substitution = Substitution(X:i>o -> λu_0 c != u_0 ∨ b = u_0)
...
\begin{clilisting}
gapt> val derivationWitnesses = wscan.witnesses(clauseSetPep, oneSidedOnly=true, derivationLimit=Some(10), attemptLimit=Some(1000), witnessLimit=Some(1)).toSeq
val derivationWitnesses:
  Seq[(gapt.logic.hol.scan.Derivation, gapt.expr.subst.Substitution)] = List((Derivation(ClauseSetPredicateEliminationProblem(Set(X:i>o),Set( ⊢ X(b), X(c) ⊢ ,  ⊢ X(a))),List(ConstraintResolution(PointedClause( ⊢ X(b),Suc(0)),PointedClause(X(c) ⊢ ,Ant(0))), PurifiedClauseDeletion(PointedClause( ⊢ X(b),Suc(0))), ConstraintResolution(PointedClause(X(c) ⊢ ,Ant(0)),PointedClause( ⊢ X(a),Suc(0))), PurifiedClauseDeletion(PointedClause(X(c) ⊢ ,Ant(0))), ExtendendPurityDeletion(X:i>o,Positive))),Substitution(X:i>o -> λu_0 c != u_0 ∨ b = u_0)), (Derivation(ClauseSetPredicateEliminationProblem(Set(X:i>o),Set( ⊢ X(b), X(c) ⊢ ,  ⊢ X(a))),List(ConstraintResolution(PointedClause( ⊢ X(b),Suc(0)),PointedClause(X(c) ⊢ ,Ant(0))), PurifiedClauseDeletion(PointedClause( ⊢ X(b),Suc(0))), ConstraintResolution(PointedClause(X(c) ⊢ ,Ant(0)),PointedCla ... large output truncated, print value to show all
