...
proof: at.logic.gapt.proofs.lk.base.LKProof = CutRuleType(∀x.∀y.(P(x,y)⊃Q(x,y)) :- ∃x.∃y.(¬Q(x,y)⊃¬P(x,y)))
...
A: at.logic.gapt.expr.FOLFormula = A

gapt> val B = SimpleFOLParser( "B" )
B: at.logic.gapt.expr.FOLFormula = B
...
p1: at.logic.gapt.proofs.lkNew.InitialSequent =
[p1] A :- A    (LogicalAxiom(A))

gapt> val p2 = Axiom( B::Nil, B::Nil )
p2: at.logic.gapt.proofs.lkNew.InitialSequent =
[p1] B :- B    (LogicalAxiom(B))
...
<console>:110: error: overloaded method value apply with alternatives:
  (leftSubProof: at.logic.gapt.proofs.lkNew.LKProof,aux1: at.logic.gapt.proofs.SequentIndex,rightSubProof: at.logic.gapt.proofs.lkNew.LKProof,aux2: at.logic.gapt.proofs.SequentIndex)at.logic.gapt.proofs.lkNew.AndRightRule <and>
  (leftSubProof: at.logic.gapt.proofs.lkNew.LKProof,leftConjunct: at.logic.gapt.proofs.lkNew.AndRightRule.IndexOrFormula,rightSubProof: at.logic.gapt.proofs.lkNew.LKProof,rightConjunct: at.logic.gapt.proofs.lkNew.AndRightRule.IndexOrFormula)at.logic.gapt.proofs.lkNew.AndRightRule
 cannot be applied to (at.logic.gapt.proofs.lkNew.InitialSequent, at.logic.gapt.proofs.lkNew.InitialSequent, at.logic.gapt.expr.FOLFormula, at.logic.gapt.expr.FOLFormula)
      val p3 = AndRightRule( p1, p2, A, B )
...
<console>:109: error: overloaded method value apply with alternatives:
  (subProof: at.logic.gapt.proofs.lkNew.LKProof,aux1: at.logic.gapt.proofs.SequentIndex,aux2: at.logic.gapt.proofs.SequentIndex)at.logic.gapt.proofs.lkNew.ImpRightRule <and>
  (subProof: at.logic.gapt.proofs.lkNew.LKProof,impPremise: at.logic.gapt.proofs.lkNew.ImpRightRule.IndexOrFormula,impConclusion: at.logic.gapt.proofs.lkNew.ImpRightRule.IndexOrFormula)at.logic.gapt.proofs.lkNew.ImpRightRule
 cannot be applied to (at.logic.gapt.expr.FOLAtom, at.logic.gapt.expr.FOLFormula, at.logic.gapt.expr.FOLFormula)
      val p4 = ImpRightRule( p3, B, F2 )
               ^

gapt> val p5 = ImpRightRule( p4, A, F1 )
<console>:108: error: not found: value p4
      val p5 = ImpRightRule( p4, A, F1 )
                             ^
...
\begin{clilisting}
gapt> prooftool( p5 )
<console>:108: error: not found: value p5
      prooftool( p5 )
                 ^
...
p: at.logic.gapt.proofs.lk.base.LKProof = CutRuleType(∀x.∀y.(P(x,y)⊃Q(x,y)) :- ∃x.∃y.(¬Q(x,y)⊃¬P(x,y)))
...
<console>:107: error: not found: value ReductiveCutElim
...
<console>:108: error: overloaded method value apply with alternatives:
  (proof: at.logic.gapt.proofs.lkNew.LKProof)at.logic.gapt.proofs.lkNew.LKProof <and>
  (formula: at.logic.gapt.expr.HOLFormula)at.logic.gapt.expr.HOLFormula
 cannot be applied to (at.logic.gapt.proofs.lk.base.LKProof)
      val q = skolemize( p )
              ^
...
\begin{clilisting}
gapt> val s = pr.root
<console>:106: error: not found: value pr
      val s = pr.root
              ^

gapt> val npart = Set( s.antecedent( 0 ), s.succedent( 0 ) )
<console>:106: error: not found: value s
      val npart = Set( s.antecedent( 0 ), s.succedent( 0 ) )
                       ^
<console>:106: error: not found: value s
      val npart = Set( s.antecedent( 0 ), s.succedent( 0 ) )
                                          ^
...
<console>:106: error: not found: value s
      val ppart = Set( s.succedent( 1 ) )
                       ^

gapt> val I = ExtractInterpolant( pr, npart, ppart )
<console>:106: error: not found: value pr
      val I = ExtractInterpolant( pr, npart, ppart )
                                  ^
<console>:106: error: not found: value npart
      val I = ExtractInterpolant( pr, npart, ppart )
                                      ^
<console>:106: error: not found: value ppart
      val I = ExtractInterpolant( pr, npart, ppart )
                                             ^
...
<console>:107: error: not found: value extractExpansionSequent
...
\begin{clilisting}
gapt> prooftool( E )
<console>:108: error: not found: value E
      prooftool( E )
                 ^
...
<console>:107: error: too many arguments for method parseFormula: (s: String)at.logic.gapt.expr.FOLFormula
      Prover9TermParser.parseFormula("(all X (P(X,f(X)) -> (exists Y P(X,Y))))", false)
                                    ^
