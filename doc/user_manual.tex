...
[p730] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (CutRule(p1, Suc(0), p729, Ant(2)))
[p729] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
0 = 0
⊢
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p728, Suc(1), Suc(0)))
[p728] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
0 = 0
⊢
∃x_1 ∃y_0 (s(x_1) <= y_0 ∧ f(x_1) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p727, Ant(3), Ant(1)))
[p727] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
...
∀x_0 ∀y_0 (x_0 <= M(x_0, y_0) ∧ y_0 <= M(x_0, y_0))
  +^{s(M(s(M(x_0, x)), s(M(x_0, x))))}
    (∀y_0 (s(M(s(M(x_0, x)), s(M(x_0, x)))) <=
            M(s(M(s(M(x_0, x)), s(M(x_0, x)))), y_0) ∧
          y_0 <= M(s(M(s(M(x_0, x)), s(M(x_0, x)))), y_0))
      +^{s(M(s(M(x_0, x)), s(M(x_0, x))))}
        ((s(M(s(M(x_0, x)), s(M(x_0, x)))) <=
            M(
            s(M(s(M(x_0, x)), s(M(x_0, x)))),
