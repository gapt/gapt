...
ExpansionProofWithCut(List(),[p19] ETWeakQuantifier(∀x.(f(x)=0∨f(x)=s(0)), M(s(M(v100,v101)),v102), p3, M(s(M(M(v100,v101),s(M(v100,v101)))),v102), p6, M(s(M(v100,v101)),s(M(s(M(v100,v101)),v102))), p9, M(s(M(M(v100,v101),s(M(v100,v101)))),s(M(s(M(M(v100,v101),s(M(v100,v101)))),v102))), p12, M(v100,v101), p15, M(M(v100,v101),s(M(v100,v101))), p18)
[p18] ETOr(p16, p17)
...
[p12] ETOr(p10, p11)
[p11] ETAtom(f(M(s(M(M(v100,v101),s(M(v100,v101)))),s(M(s(M(M(v100,v101),s(M(v100,v101)))),v102))))=s(0), false)
[p10] ETAtom...
gapt> prooftool(et)
