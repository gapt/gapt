...
gapt> (A & B) --> C
res4: gapt.expr.FOLFormula = A ∧ B → C
...
c: Q(a)
  ...
  at gapt.proofs.gaptic.Lemma$.finish(language.scala:18)
  at gapt.proofs.gaptic.Lemma$.finish(language.scala:22)
  at gapt.proofs.gaptic.Lemma$Helper.handleTacticBlock(language.scala:34)
  ... 25 elided
\end{tacticsoutput}
...
res27: Option[gapt.proofs.lk.LKProof] =
Some([p11] ∀x (p(x) → p(s(x))), p(0) ⊢ p(s(s(0)))    (ContractionLeftRule(p10, Ant(2), Ant(1)))
[p10] p(0), ∀x (p(x) → p(s(x))), ∀x (p(x) → p(s(x))) ⊢ p(s(s(0)))    (CutRule(p5, Suc(0), p9, Ant(1)))
[p9] ∀x (p(x) → p(s(x))), p(s(0)) ⊢ p(s(s(0)))    (CutRule(p8, Suc(0), p6, Ant(0)))
[p8] ∀x (p(x) → p(s(x))), p(s(0)) ⊢ p(s(s(0)))    (ForallLeftRule(p7, Ant(0), p(x) → p(s(x)), s(0), x))
...
res28: Option[gapt.proofs.expansion.ExpansionProof] =
Some(
:-
...
res29: Option[gapt.proofs.expansion.ExpansionProof] =
Some(∀x (p(x) → p(s(x))) +^{0} (p(0)+ → p(s(0))-) +^{s(0)} (p(s(0))+ → p(s(s(0)))-),
p(0)-
:-
p(s(s(0)))+)
...
res30: gapt.formats.tptp.TptpFile =
fof(ant_0, axiom, p('0')).
...
res49: Option[gapt.models.PropositionalModel] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
res50: Option[gapt.proofs.resolution.ResolutionProof] =
...
[p28] b + (c + (d + a)) = d + (a + b + c) ⊢    (Paramod(p22, Suc(0), true, p27, A...
...
[p474] ∀x (f(x) = 0 ∨ f(x) = s(0)),
∀x ∀y_0 (x <= M(x, y_0) ∧ y_0 <= M(x, y_0))
⊢
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1))    (CutRule(p1, Suc(0), p473, Ant(2)))
[p473] ∀x (f(x) = 0 ∨ f(x) = s(0)),
∀x ∀y_0 (x <= M(x, y_0) ∧ y_0 <= M(x, y_0)),
0 = 0
⊢
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1))    (ContractionRightRule(p472, Suc(1), Suc(0)))
[p472] ∀x (f(x) = 0 ∨ f(x) = s(0)),
∀x ∀y_0 (x <= M(x, y_0) ∧ y_0 <= M(x, y_0)),
0 = 0
⊢
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1))    (ContractionLeftRule(p471, Ant(3), Ant(1)))
[p471] ∀x ∀y_0 (x <= M(x, y_0) ∧ y_0 <= M(x, y_0)),
∀x (f(x) = 0 ∨ f(x) = s(0)),
0 = 0,
∀x (f(x) = 0 ∨ f(x) = s(0))
⊢
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1)),
∃x ∃y_1 (s(x) <= y_1 ∧ f(x) = f(y_1))    (ContractionLeftRule(...
...
∀x (f(x) = 0 ∨ f(x) = s(0))
  +^{M(s(M(v_1, s(M(s(M(v_2, v_3)), v)))), s(M(s(M(v_2, v_3)), v)))}
    ((f(M(s(M(v_1, s(M(s(M(v_2, v_3)), v)))), s(M(s(M(v_2, v_3)), v)))) = 0)- ∨
      (f(M(s(M(v_1, s(M(s(M(v_2, v_3)), v)))), s(M(s(M(v_2, v_3)), v)))) =
          s(0))-)
  +^{M(s(M(v_1, s(M(v_0, s(M(s(M(v_2, v_3)), v)))))), s(M(s(M(v_2, v_3)), v)))}
    ((f(M(s(M(v_1, s(M(v_0, s(M(s(M(v_2, v_3)), v)))))),
                  s(M(s(M(v_2, v_3)), v)))) =
          0)- ∨
      (f(M(s(M(v_1, s(M(v_0, s(M(s(M(v_2, v_3)), v)))))),
                  s(M(s(M(v_2, v_3)), v)))) =
          s(0))-)
  +^{M(s(M(v_1, s(M(v_0, s(M(v_2, v_3)))))), s(M(v_2, v_3)))}
    ((f(M(s(M(v_1, s(M(v_0, s(M(v_2, v_3)))))), s(M(v_2, v_3)))) = 0)- ∨
      (f(M(s(M(v_1, s(M(v_0,...
