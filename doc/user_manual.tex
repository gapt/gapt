...
∀x ∀y_0 (x <= M(x, y_0) ∧ y_0 <= M(x, y_0))
  +^{s(M(v_1, s(M(v_2, v_3))))}
    ∀y_0
      (s(M(v_1, s(M(v_2, v_3)))) <= M(s(M(v_1, s(M(v_2, v_3)))), y_0) ∧
        y_0 <= M(s(M(v_1, s(M(v_2, v_3)))), y_0))
    +^{s(M(s(M(v_4, v)), v_0))}
      (s(M(v_1, s(M(v_2, v_3)))) <=
    ...
    +^{s(M(v_4, v))}
      (s(M(v_1, s(M(v_2, v_3)))) <=
          M(s(M(v_1, s(M(v_2, v_3)))), s(M(v_4, v))))- ∧
      (s(M(v_4, v)) <= M(s(M(v_1, s(M(v_2, v_3)))), s(M(v_4, v))))-
  +^{s(M(v_2, v_3))}
    ∀y_0
      (s(M(v_2, v_3)) <= M(s(M(v_2, v_3)), y_0) ∧ y_0 <= M(s(M(v_2, v_3)), y_0))
    +^{s(M(s(M(v_4...
