...
gapt> val grammar = findMinimalVectGrammar(lang.toSet, Seq(1,1))
grammar: at.logic.gapt.grammars.VTRATG =
Non-terminal vectors: (x0), (x_0_0), (x_1_0)
Terminals: 0, s:i>i

x0 → s(s(s(s(s(s(s(s(s(s(x_0_0))))))))))
...
\begin{clilisting}[OpenWBO.isInstalled]
gapt> minimizeVectGrammar(grammar, Set(1,2,4,5) map {Numeral(_)})
