...
p: at.logic.gapt.proofs.nd.ForallIntroRule =
[p4]  ⊢ ∀x ∃y (y:nat) = (s(0:nat): nat) + (x:nat)    (ForallIntroRule(p3, x:nat, x:nat))
[p3]  ⊢ ∃y (y:nat) = (s(0:nat): nat) + (x:nat)    (ExistsIntroRule(p2, (y:nat) = (s(0:nat): nat) + (x:nat), s(x:nat): nat, y:nat))
[p2]  ⊢ (s(x:nat): nat) = s(0) + x    (DefinitionRule(p1, (s(x:nat): nat) = s(0) + x))
