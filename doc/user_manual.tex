...
res11: at.logic.gapt.proofs.lk.LKProof =
...
res12: at.logic.gapt.proofs.nd.NDProof =
...
res13: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.Formula] = ∀X (X ⊃ X), ∀x ∀y (P(x, y) ⊃ Q(x, y)) ⊢ ∃x ∃y (¬Q(x, y) ⊃ ¬P(x, y))

gapt> expansion.deep
res14: at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.Formula] = ¬P(x, a) ∨ Q(x, a) ⊃ ¬P(b, y) ∨ Q(b, y), P(x, a) ⊃ Q(x, a) ⊢ ¬Q(b, y) ⊃ ¬P(b, y)
...
res16: at.logic.gapt.proofs.expansion.ExpansionProof =
∀x ∀y (P(x, y) ⊃ Q(x, y))
...
res17: at.logic.gapt.proofs.lk.LKProof =
...
res20: Option[at.logic.gapt.proofs.resolution.ResolutionProof] =
...
res22: Option[at.logic.gapt.proofs.expansion.ExpansionProof] =
...
res23: Option[at.logic.gapt.proofs.lk.LKProof] =
Some([p11] ∀x (p(x) ⊃ p(s(x))), p(0) ⊢ p(s(s(0)))    (ContractionLeftRule(p10, Ant(2), Ant(1)))
[p10] p(0), ∀x (p(x) ⊃ p(s(x))), ∀x (p(x) ⊃ p(s(x))) ⊢ p(s(s(0)))    (CutRule(p5, Suc(0), p9, Ant(1)))
[p9] ∀x (p(x) ⊃ p(s(x))), p(s(0)) ⊢ p(s(s(0)))    (CutRule(p8, Suc(0), p6, Ant(0)))
[p8] ∀x (p(x) ⊃ p(s(x))), p(s(0)) ⊢ p(s(s(0)))    (ForallLeftRule(p7, Ant(0), p(x) ⊃ p(s(x)), s(0), x))
...
res24: Option[at.logic.gapt.proofs.expansion.ExpansionProof] =
Some(
:-
...
res26: at.logic.gapt.formats.tptp.TptpFile =
fof(ant_0, axiom, p('0')).
...
gapt> tptp.toSequent
res27: at.logic.gapt.proofs.HOLSequent =
i(sr2),
¬i(two),
times(sr2, sr2) = two,
...
res39: at.logic.gapt.expr.Atom = R(p_3, h_1): o
...
res43: Option[at.logic.gapt.proofs.drup.DrupProof] =
Some([derive]  ⊢
[derive] R(p_3, h_2) ⊢
[derive]  ⊢ R(p_4, h_3)
...
res44: Option[at.logic.gapt.proofs.lk.LKProof] =
Some([p402]
⊢
...
res45: Option[at.logic.gapt.models.Interpretation] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
res46: Option[at.logic.gapt.proofs.resolution.ResolutionProof] =
...
res48: at.logic.gapt.proofs.lk.LKProof =
[p5]  ⊢ a ⊃ b ⊃ a ∧ b    (ImpRightRule(p4, Ant(0), Suc(0)))
[p4] a ⊢ b ⊃ a ∧ b    (ImpRightRule(p3, Ant(1), Suc(0)))
[p3] a, b ⊢ a ∧ b    (AndRightRule(p1, Suc(0), p2, Suc(0)))
[p2] b ⊢ b    (LogicalAxiom(b:o))
...
res49: at.logic.gapt.proofs.lk.LKProof =
...
res56: at.logic.gapt.grammars.VTRATG =
Non-terminal vectors: (x_0), (x_1), (x_2)
Terminals: 0, s:i>i
