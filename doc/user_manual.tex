...
A collection of formula sequences can be found in the file \cli{examples/lib/FormulaSequences.scala}.
...
res12: Boolean = true
\end{lstlisting}
This shows that $\mathrm{PHP}_{3,2}$ is valid, and
\begin{lstlisting}
...
\cli{examples/lib/ProofSequences.scala} which are generated in the above style.
Have a look at this code for more complicated proof constructions.  These are
available by default in the CLI.
