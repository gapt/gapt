...
p: at.logic.gapt.proofs.lk.LKProof =
[p39] ∀x ∀y (P(x, y) ⊃ P(x, s(y))),
∀x ∀y (P(x, y) ⊃ P(s(x), y)),
P(0, 0): o
:-
P(s(s(s(s(0)))), s(s(s(s(0))))): o    (ContractionLeftRule(p38, Ant(0), Ant(1)))
[p38] ∀x ∀y (P(x, y) ⊃ P(x, s(y))),
∀x ∀y (P(x, y) ⊃ P(x, s(y))),
∀x ∀y (P(x, y) ⊃ P(s(x), y)),
P(0, 0): o
:-
P(s(s(s(s(0)))), s(s(s(s(0))))): o    (ForallLeftRule(p37, Ant(0), ∀y (P(x, y) ⊃ P(x, s(y))), s(s(s(s(0)))), x))
[p37] ∀y (P(s(s(s(s(0)))), y) ⊃ P(s(s(s(s(0)))), s(y))),
∀x ∀y (P(x, y) ⊃ P(x, s(y))),
∀x ∀y (P(x, y) ⊃ P(s(x), y)),
P(0, 0): o
:-
P(s(s(s(s(0)))), s(s(s(s(0))))): o    (ForallLeftRule(p36, Ant(0), P(s(s(s(s(0)))), y) ⊃ P(s(s(s(s(0)))), s(y)), s(s(s(0))), y))
[p36] P(s(s(s(s(0)))), s(s(s(0)))) ⊃ P(s(s(s(s(0)))), s(s(s(s(0))))),
∀x ∀y (P(x, y) ⊃ P(x, s(y))),
∀x ∀y (P(x, y) ⊃...
