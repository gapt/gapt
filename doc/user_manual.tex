...
[p738] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0))
:-
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (CutRule(p1, Suc(0), p737, Ant(2)))
[p737] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
0 = 0
:-
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionRightRule(p736, Suc(1), Suc(0)))
[p736] ∀x_1 ∀y (x_1 <= M(x_1, y) ∧ y <= M(x_1, y)),
∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
0 = 0
:-
∃x_1 ∃y_0 (s(x_1) <= y_0 ∧ f(x_1) = f(y_0)),
∃x ∃y_0 (s(x) <= y_0 ∧ f(x) = f(y_0))    (ContractionLeftRule(p735, Ant(3), Ant(1)))
[p735] ∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)),
