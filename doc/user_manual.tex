...
ExpansionProofWithCut(List(),[p19] ETWeakQuantifier(∀x_1 (f(x_1) = 0 ∨ f(x_1) = s(0)), M(s(M(v100, v101)), v102), p3, M(s(M(M(v100, v101), s(M(v100, v101)))), v102), p6, M(s(M(v100, v101)), s(M(s(M(v100, v101)), v102))), p9, M(
