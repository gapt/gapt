...
\lstnewenvironment{tacticslisting}{\lstset{language=scala}}{}
...
val eqEx = Lemma(Sequent(
    Seq("c" -> fof"P(y) & Q(y)",
        ...
        "a" -> fof"P(u) -> Q(u)"),
    Seq("b" -> fof"P(x) & Q(x)"))) {
  eql("eq1", "a").to(fof"P(v) -> Q(v)")
  eql("eq1", "a").to(fof"P(v) -> Q(u)")
...
res17: Option[at.logic.gapt.proofs.drup.DrupProof] =
Some([derive]  :-
[derive] R(p_1, h_1): o :-
[derive]  :- R(p_4, h_2): o
...
res18: Option[at.logic.gapt.proofs.lk.LKProof] =
Some([p394]
:-
...
res19: Option[at.logic.gapt.models.Interpretation] =
Some(a:o -> false
b:o -> false
c:o -> true)
...
res25: Option[at.logic.gapt.proofs.resolution.ResolutionProof] =
...
res30: Option[at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula]] = Some(p(0): o, (p(0) ⊃ p(s(0))) ∧ (p(s(0)) ⊃ p(s(s(0)))) :- p(s(s(0))): o)
...
res32: at.logic.gapt.proofs.lk.solvePropositional.UnprovableOrLKProof =
\/-([p5]  :- a ⊃ b ⊃ a ∧ b    (ImpRightRule(p4, Ant(0), Suc(0)))
[p4] a:o :- b ⊃ a ∧ b    (ImpRightRule(p3, Ant(1), Suc(0)))
[p3] a:o, b:o :- a ∧ b    (AndRightRule(p1, Suc(0), p2, Suc(0)))
[p2] b:o :- b:o    (LogicalAxiom(b:o))
...
res39: at.logic.gapt.grammars.TratGrammar =
Axiom: x0
Non-terminals: x0, x1, x2
Productions:
  x0 -> s(x1)
