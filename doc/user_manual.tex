...
\begin{clilisting}
gapt> val q = CutIntroduction(p, method=DeltaTableMethod(), verbose=true)
Quantifier inferences in the input proof: 9
End sequent: ∀x (P(x) ⊃ P(s(x))), P(0) ⊢ P(s(s(s(s(s(s(s(s(s(0))))))))))
Size of term set: 11 (weighted by root symbol arity = 9)
Smallest grammar of size 8 (weighted by vector size = 8):
...
CNF of minimized cut-formula number 0:
  P(x1) ⊢ P(s(s(s(x1))))
Beautified grammar of size 8 (weighted by vector size = 8):
