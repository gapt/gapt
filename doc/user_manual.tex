...
cnf: Set[at.logic.gapt.proofs.HOLClause] = Set( :- R(p_1, h_1): o, R(p_1, h_2): o, R(p_1, h_3): o, R(p_2, h_3): o, R(p_1, h_3): o :- , R(p_3, h_1): o, R(p_1, h_1): o :- , R(p_2, h_1): o, R(p_1, h_1): o :- ,  :- R(p_2, h_1): o, R(p_2, h_2): o, R(p_2, h_3): o, R(p_3, h_2): o, R(p_2, h_2): o :- , R(p_3, h_3): o, R(p_2, h_3): o :- , R(p_3, h_3): o, R(p_1, h_3): o :- , R(p_2, h_2): o, R(p_1, h_2): o :- , R(p_3, h_1): o, R(p_2, h_1): o :- , R(p_3, h_2): o, R(p_1, h_2): o :- ,  :- R(p_3, h_1): o, R(p_3, h_2): o, R(p_3, h_3): o)
...
res14: at.logic.gapt.expr.HOLAtom = R(p_1, h_1): o
...
[derive] R(p_2, h_2): o :-
[derive]  :- R(p_2, h_3): o
[derive] R(p_2, h_1): o :- R(p_3, h_3): o
[derive] R(p_1, h_1): o :- R(p_2, h_3): o
[derive] R(p_1, h_2): o :- R(p_2, h_3): o
[derive] R(p_3, h_2): o :- R(p_1, h_3): o, R(p_2, h_3): o
[derive] R(p_4, h_3): o :-
[derive] R(p_3, h_1): o :- R(p_2, h_3): o, R(p_1, h_3): o
[input]  :- R(p_3, h_1): o, R(p_3, h_2): o, R(p_3, h_3): o
[input] R(p_4, h_1): o, R(p_3, h_1): o :-
[input] R(p_2, h_1): o, R(p_1, h_1): o :-
[input] R(p_4, h_2): o, R(p_1, h_2): o :-
[input]  :- R(p_1, h_1): o, R(p_1, h_2): o, R(p_1, h_3): o
[input]  :- R(p_2, h_1): o, R(p_2, h_2): o, R(p_2, h_3): o
[input] R(p_3, h_2): o, R(p_2, h_2): o :-
[input] R(p_4, h_2): o, R(p_2,...
\end{clilisting}
...
res31: Option[at.logic.gapt.proofs.Sequent[at.logic.gapt.expr.HOLFormula]] = Some(p(0): o, (p(0) ⊃ p(s(0))) ∧ (p(s(0)) ⊃ p(s(s(0)))) :- p(s(s(0))): o)
...
Some([p40]  :-     (Resolution(p1, Suc(0), p39, Ant(0)))
[p39] b + (c + (a + d)) = b + (c + (a + d)) :-     (Paramodulation(p3, Suc(0), p38, Ant(0), λx b + (c + (a + d)) = b + (c + x), false))
[p38] b + (c + (a + d)) = b + (c + (d + a)) :-     (Paramodulation(p13, Suc(0), p37, Ant(0), λx b + (c + (a + d)) = x, true))
[p37] b + (c + (a + d)) = c + (b + (d + a)) :-     (Paramodulation(p14, Suc(0), p36, Ant(0), λx b + (c + (a + d)) = c + x, true))
[p36] b + (c + (a + d)) = c + (d + (b + a)) :-     (Paramodulation(p15, Suc(0), p35, Ant(0), λx b + (c + (a + d)) = x, true))
[p35] b + (c + (a + d)) = d + (c + (b + a)) :-     (Resolution(p18, Suc(0), p34, Ant(0)))
[p34] d + (c + (b + a)) = b + (c + (a + d)) :-     (Paramodulation(...
\end{clilisting}
