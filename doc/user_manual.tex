...
Another version of this method is called \texttt{witnessForSecondOrderQuantifierElimination}.
...
gapt> val solution = witnessForSecondOrderQuantifierElimination(hof"∃X X(a)")
...
To get a more detailed description of the kinds of formulas for which the algorithm succeeds check the documentation of \texttt{solveFormulaEquation} and \texttt{witnessForSecondOrderQuantifierElimination}.
