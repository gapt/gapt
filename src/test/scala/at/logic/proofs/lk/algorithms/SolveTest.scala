...
import at.logic.proofs.expansionTrees.{ExpansionSequent, toSequent, Atom => AtomET, Neg => NegET, Or => OrET, StrongQuantifier => StrongQuantifierET, WeakQuantifier => WeakQuantifierET}
