...
package searchAlgorithms {
  ...
  object SearchAlgorithms {
     ...
     */
    def GenericSearch[NodeType, CollType <: SearchCollection[NodeType]]( sc: CollType, root: NodeType, succ: NodeType => List[NodeType] ): List[NodeType] = {
     ...
     * @return The list of nodes which have no successors (=goal nodes in this context).
     */
    def GenericSearch[NodeType, CollType <: SearchCollection[NodeType]]( sc: CollType, root: NodeType, succ: NodeType => List[NodeType], goal: NodeType => Boolean ): List[NodeType] = {
      def innerSearch( sc: CollType ): List[NodeType] = {
        //no more nodes to expand => search is finished.
        if ( sc.size == 0 ) { Nil }
        else {
     ...
     */
    def setSearch[ElemType, NodeType <: SetNode[ElemType]]( elemFilter: ( NodeType, ( ElemType, Int ) ) => Boolean, nodeFilter: NodeType => Boolean, node: NodeType ): List[NodeType] = {
