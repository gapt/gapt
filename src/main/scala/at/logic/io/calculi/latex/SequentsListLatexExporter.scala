...
package at.logic.io.calculi.latex
...
import at.logic.io.ExportingException
import at.logic.io.OutputExporter
import at.logic.io.language.latex.HOLTermLatexExporter
...
trait LabelledSequentsListLatexExporter extends HOLTermLatexExporter {
  ...
  def exportSequentList( ls: List[LabelledSequent], sections: List[Tuple2[String, List[Tuple2[Any, Any]]]] ): at.logic.io.OutputExporter = {
    // first obtain information about the clauses, replace lambda expressions of constant type by constants (and describe it at the top of the page)
    // Also describe the types of all constants
