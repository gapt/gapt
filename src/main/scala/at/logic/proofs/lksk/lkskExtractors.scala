...
import at.logic.proofs.lk.{ WeakeningLeftRuleType, WeakeningRightRuleType }
import at.logic.proofs.lk.{ ForallLeftRuleType, ExistsRightRuleType, ForallRightRuleType, ExistsLeftRuleType }
