...
/**
 * Implements sequents of MultiExpansionTrees, analogous to [[at.logic.proofs.expansionTrees.ExpansionSequent]]s.
 *
...
class MultiExpansionSequent( val antecedent: Seq[MultiExpansionTree], val succedent: Seq[MultiExpansionTree] ) {
   ...
   *
   * @param f A function of type [[at.logic.proofs.expansionTrees.MultiExpansionTree]] → [[at.logic.proofs.expansionTrees.MultiExpansionTree]]
   ...
   * Maps a function over the sequent.
   *
   * @param f A function of type [[at.logic.proofs.expansionTrees.MultiExpansionTree]] → [[at.logic.language.hol.HOLFormula]]
   * @return The result of the map.
   */
