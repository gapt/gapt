...
import at.logic.proofs.expansionTrees.{ METAnd, METAtom, METImp, METNeg, METOr, METSkolemQuantifier, METStrongQuantifier, METWeakQuantifier, MultiExpansionSequent, MultiExpansionTree, _ }
