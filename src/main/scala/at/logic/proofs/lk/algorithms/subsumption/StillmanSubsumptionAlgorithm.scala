...
import at.logic.language.fol.{ FOLFormula, FOLExpression, Substitution => SubstitutionFOL, FOLNeg => NegFOL, FOLVar, freeVariables => freeVariablesFOL, rename => renameFOL }
