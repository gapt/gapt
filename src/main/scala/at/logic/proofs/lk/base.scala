package at.logic.proofs.lk.base
 ...
 * stored as a [[at.logic.proofs.occurrences.FormulaOccurrence]].
 *
...
class Sequent( val antecedent: Seq[FormulaOccurrence], val succedent: Seq[FormulaOccurrence] ) {
  ...
  /**
   * Removes the specified [[at.logic.proofs.occurrences.FormulaOccurrence]]s from each side.
   */
