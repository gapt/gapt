...
import at.logic.gapt.proofs.expansionTrees.{ ExpansionSequent, METAnd, METAtom, METImp, METNeg, METOr, METSkolemQuantifier, METStrongQuantifier, METWeakQuantifier, MultiExpansionSequent, MultiExpansionTree }
