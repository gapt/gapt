...
import at.logic.gapt.formats.xml.XMLParser.XMLNodeParser
import at.logic.gapt.proofs.proofs.{ BinaryRuleTypeA, NullaryRuleTypeA, UnaryRuleTypeA, _ }
import at.logic.gapt.utils.ds.trees.{ BinaryTree, LeafTree, UnaryTree }
