...
import at.logic.models.{ MapBasedInterpretation, Interpretation }
import at.logic.parsing.language.dimacs.DIMACSHelper
...
trait MaxSATSolver extends at.logic.utils.logging.Logger {
