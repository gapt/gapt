% modified vampire proof (expand skolemization steps with f6a)
...
fof(f5,plain,(
  ! [X0,X1] : (p(X0) & q(X0,sK0(X1,X0),X1))),
    inference(skolemize,[status(esa),new_symbols(skolem,[sK0]),skolemize(X2,sK0(X1,X0))],[f1])). %TODO: decide if this is a mistake
fof(f6,plain,(
