cnf(p0, axiom, 'P'('0'), file('Problems/correctresolution.p', a0)).
fof(p1, plain, 'P'('0'), inference(subst, [status(thm)], [p0])).
fof(p2, axiom, ![X]: ('P'(X) => 'P'(s(X))), file('Problems/correctresolution.p', a1)).
...
cnf(p19, axiom, ~ 'P'(s(s(s(s(s('0')))))), file('Problems/correctresolution.p', a2)).
