  ...
  "replaceAtHOLPosition" should {
    ...
    "correctly replace an argument in a conjunction" in {
      ...
      replaceAtHOLPosition(
        ETAnd(ETAtom(Pxy, Polarity.InSuccedent), ETAtom(Pxy, Polarity.InSuccedent)),
        xPos,
        a
      ) should
    ...
    "correctly replace a predicate in a conjunction" in {
      ...
      replaceAtHOLPosition(
        ETAnd(ETAtom(Pxy, Polarity.InSuccedent), ETAtom(Fxy, Polarity.InSuccedent)),
        FPos,
        P
      ) should
    ...
    "correctly replace an argument in a disjunction" in {
      ...
      replaceAtHOLPosition(
        ETOr(ETAtom(Pxy, Polarity.InSuccedent), ETAtom(Pxy, Polarity.InSuccedent)),
        xPos,
        a
      ) should
    ...
    "correctly replace a predicate in a disjunction" in {
      ...
      replaceAtHOLPosition(
        ETOr(ETAtom(Pxy, Polarity.InSuccedent), ETAtom(Fxy, Polarity.InSuccedent)),
        FPos,
        P
      ) should
    ...
    "correctly replace an argument in an implication" in {
      ...
      replaceAtHOLPosition(
        ETImp(ETAtom(Pxy, Polarity.InAntecedent), ETAtom(Pxy, Polarity.InSuccedent)),
        xPos,
        a
      ) should
    ...
    "correctly replace a predicate in a implication" in {
      ...
      replaceAtHOLPosition(
        ETImp(ETAtom(Pxy, Polarity.InAntecedent), ETAtom(Fxy, Polarity.InSuccedent)),
        FPos,
        P
      ) should
    ...
    "correctly replace an argument in a strong quantifier node" in {
      ...
      replaceAtHOLPosition(
        ETStrongQuantifier(AllyFxy, y, ETAtom(Fxy, Polarity.InSuccedent)),
        xPos,
        a
      ) should
      ...
      replaceAtHOLPosition(
        ETWeakQuantifier(
          ...
          Map(
            ...
            b -> ETAtom(Atom(F, x, b), Polarity.InSuccedent)
          )
        ),
        xPos,
        b
