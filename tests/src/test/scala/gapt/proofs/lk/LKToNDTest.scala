...
class LKToNDTest extends Specification with SatMatchers with SequentMatchers {
  ...
  "The LK to ND translation" should {
    ...
    "translate DeMorgan's law Or To And" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"B")).u(OrRightRule(_, hof"A | B")).u(NegLeftRule(_, hof"A | B")).u(NegRightRule(_, hof"A")).c(LogicalAxiom(hof"B")).u(WeakeningRightRule(_, hof"A")).u(OrRightRule(_, hof"A | B")).u(NegLeftRule(_, hof"A | B")).u(NegRightRule(_, hof"B")).b(AndRightRule(_, _, hof"-A & -B")).u(ContractionLeftRule(_, hof"-(A | B)")).qed
    ...
    "translate DeMorgan's law And To Or" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(NegLeftRule(_, hof"A")).u(WeakeningLeftRule(_, hof"B")).c(LogicalAxiom(hof"B")).u(NegLeftRule(_, hof"B")).u(WeakeningLeftRule(_, hof"A")).b(OrLeftRule(_, _, hof"-A | -B")).u(ContractionLeftRule(_, hof"A")).u(ContractionLeftRule(_, hof"B")).u(AndLeftRule(_, hof"A & B")).u(NegRightRule(_, hof"A & B")).qed
    ...
    "translate AndRight with focus 0" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"B")).u(WeakeningRightRule(_, hof"C")).b(AndRightRule(_, Suc(0), _, Suc(0))).qed
    ...
    "translate OrLeft 1" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"B")).b(OrLeftRule(_, _, hof"A | B")).qed
    ...
    "translate OrLeft 2" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"A")).b(OrLeftRule(_, _, hof"A | A")).qed
    ...
    "translate OrLeft 3" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"B")).u(WeakeningRightRule(_, hof"C")).u(WeakeningLeftRule(_, hof"D")).b(OrLeftRule(_, _, hof"A | D")).qed
    ...
    "translate OrLeft 4 with focus 3" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"C")).c(LogicalAxiom(hof"B")).u(WeakeningRightRule(_, hof"C")).u(WeakeningLeftRule(_, hof"D")).b(OrLeftRule(_, _, hof"A | D")).qed
    ...
    "translate OrLeft 5 with focus 2" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningLeftRule(_, hof"A")).u(NegRightRule(_, hof"A")).c(LogicalAxiom(hof"B")).u(WeakeningRightRule(_, hof"B")).b(OrLeftRule(_, _, hof"A | B")).qed
    ...
    "translate ImpRight 1 with focus 1" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"B")).u(ImpRightRule(_, hof"A -> B")).qed
    ...
    "translate OrRight case 1 with focus 0" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"C")).u(WeakeningRightRule(_, hof"B")).u(OrRightRule(_, hof"A | B")).qed
    ...
    "translate OrRight case 2 with Weakening" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"B")).u(WeakeningRightRule(_, hof"C")).u(OrRightRule(_, hof"A | B")).qed
    ...
    "translate OrRight case 2 with Negation" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningLeftRule(_, hof"B")).u(NegRightRule(_, hof"B")).u(OrRightRule(_, hof"A | -B")).qed
    ...
    "translate OrLeft followed by NegRight with focus 1" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"B")).b(OrLeftRule(_, _, hof"A | B")).u(NegRightRule(_, hof"A | B")).qed
    ...
    "translate NegRight" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningLeftRule(_, hof"B")).u(NegRightRule(_, hof"B")).qed
    ...
    "translate WeakeningRight followed by ContractRight" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"A")).u(ContractionRightRule(_, hof"A")).qed
    ...
    "translate Cut 1" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"A")).b(CutRule(_, Suc(0), _, Ant(0))).qed
    ...
    "translate Cut 2" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningLeftRule(_, hof"B")).c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"C")).b(CutRule(_, Suc(0), _, Ant(0))).qed
    ...
    "translate ImpLeft with focus 0" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"C")).c(LogicalAxiom(hof"B")).u(WeakeningLeftRule(_, hof"D")).b(ImpLeftRule(_, _, hof"A -> B")).qed
    ...
    "translate LEM" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(NegRightRule(_, hof"A")).u(OrRightRule(_, hof"A | -A")).qed
    ...
    "translate WeakeningRight with focus 0" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"A")).u(WeakeningRightRule(_, hof"B")).qed
    ...
    "translate ForAll left and right" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(hof"A t")).u(ForallLeftRule(_, hof"!x A x", fov"t")).u(ForallRightRule(_, hof"!x A x", fov"t")).qed
    ...
    "translate ExistsRight" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(hof"A v")).u(ExistsRightRule(_, hof"?x A x", fov"v")).qed
    ...
    "translate Exists right and left" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(hof"A v")).u(ExistsRightRule(_, hof"?x A x", fov"v")).u(ExistsLeftRule(_, hof"?x A x", fov"v")).qed
    ...
    "translate WeakeningLeft followed by ContractLeft" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningLeftRule(_, hof"A")).u(ContractionLeftRule(_, hof"A")).qed
    ...
    "translate WeakeningLeft with empty succedent" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(NegLeftRule(_, hof"A")).u(WeakeningLeftRule(_, hof"B")).qed
    ...
    "translate ContractionLeft with empty succedent" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(NegLeftRule(_, hof"A")).u(WeakeningLeftRule(_, hof"A")).u(ContractionLeftRule(_, hof"A")).qed
    ...
    "translate AndLeft and OrLeft with focus on 'wrong' formula" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(WeakeningRightRule(_, hof"B")).u(WeakeningRightRule(_, hof"C")).u(OrRightRule(_, hof"A | B")).c(LogicalAxiom(hof"D")).b(AndRightRule(_, _, hof"C & D")).qed
    ...
    "translate ImpLeft with empty succedent" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"B")).u(NegLeftRule(_, hof"B")).b(ImpLeftRule(_, _, hof"A -> B")).qed
    ...
    "translate Cut with empty succedent" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).c(LogicalAxiom(hof"A")).u(NegLeftRule(_, hof"A")).b(CutRule(_, Suc(0), _, Ant(1))).qed
    ...
    "translate ForallLeft with empty succedent" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(hof"A t")).u(NegLeftRule(_, hof"A t")).u(ForallLeftRule(_, hof"!x A x", fov"t")).qed
    ...
    "translate ExistsLeft with empty succedent" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(hof"A v")).u(ExistsRightRule(_, hof"?x A x", fov"v")).u(NegLeftRule(_, hof"?x A x")).u(ExistsLeftRule(_, hof"?x A x", fov"v")).qed
    ...
    "translate EqualityLeft" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(Pc)).u(WeakeningLeftRule(_, Pd)).u(WeakeningRightRule(_, Pd)).u(WeakeningLeftRule(_, hof"$c = $d")).u(EqualityLeftRule(_, Eq(c, d), Pc, Pd)).qed
    ...
    "translate EqualityLeft, empty succedent" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(Pc)).u(NegLeftRule(_, Suc(0))).u(WeakeningLeftRule(_, Pd)).u(WeakeningLeftRule(_, hof"$c = $d")).u(EqualityLeftRule(_, Eq(c, d), Pc, Pd)).qed
    ...
    "translate EqualityLeft, multiple replacements" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(Pc)).u(WeakeningLeftRule(_, Pccc)).u(WeakeningLeftRule(_, Pd)).u(WeakeningRightRule(_, Pd)).u(WeakeningLeftRule(_, hof"$c = $d")).u(EqualityLeftRule(_, Eq(c, d), Pccc, Pccd)).qed
    ...
    "translate EqualityRight" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(Pc)).u(WeakeningLeftRule(_, Pd)).u(WeakeningRightRule(_, Pd)).u(WeakeningLeftRule(_, hof"$c = $d")).u(EqualityRightRule(_, Eq(c, d), Pc, Pd)).qed
    ...
    "translate EqualityRight multiple replacements" in {
      ...
      val lk = ProofBuilder.c(LogicalAxiom(Pccc)).u(WeakeningLeftRule(_, Pd)).u(WeakeningRightRule(_, Pd)).u(WeakeningLeftRule(_, hof"$c = $d")).u(EqualityRightRule(_, Eq(c, d), Pccc, Pccd)).qed
    ...
    "translate DefinitionLeftRule" in {
      val lk = ProofBuilder.c(LogicalAxiom(hof"A")).u(ConversionLeftRule(_, Ant(0), hof"B")).qed
