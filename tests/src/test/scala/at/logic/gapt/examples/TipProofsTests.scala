...
class TipProofsTests extends Specification {
  ...
  // prod
  "prod/prop_01" in { at.logic.gapt.examples.tip.prod.prop_01; ok }
  "prod/prop_04" in { at.logic.gapt.examples.tip.prod.prop_04; ok }
  "prod/prop_05" in { at.logic.gapt.examples.tip.prod.prop_05; ok }
  "prod/prop_06" in { at.logic.gapt.examples.tip.prod.prop_06; ok }
  "prod/prop_07" in { at.logic.gapt.examples.tip.prod.prop_07; ok }
  "prod/prop_08" in { at.logic.gapt.examples.tip.prod.prop_08; ok }
  "prod/prop_10" in { at.logic.gapt.examples.tip.prod.prop_10; ok }
  "prod/prop_13" in { at.logic.gapt.examples.tip.prod.prop_13; ok }
  "prod/prop_15" in { at.logic.gapt.examples.tip.prod.prop_15; ok }
  "prod/prop_16" in { at.logic.gapt.examples.tip.prod.prop_16; ok }
  "prod/prop_20" in { at.logic.gapt.examples.tip.prod.prop_20; ok }
  "prod/prop_27" in { at.logic.gapt.examples.tip.prod.prop_27; ok }
  "prod/prop_28" in { at.logic.gapt.examples.tip.prod.prop_28; ok }
  "prod/prop_29" in { at.logic.gapt.examples.tip.prod.prop_29; ok }
  "prod/prop_30" in { at.logic.gapt.examples.tip.prod.prop_30; ok }
  "prod/prop_31" in { if ( !OpenWBO.isInstalled ) skipped( "no openwbo" ); at.logic.gapt.examples.tip.prod.prop_31; ok }
  "prod/prop_32" in { at.logic.gapt.examples.tip.prod.prop_32; ok }
  "prod/prop_33" in { at.logic.gapt.examples.tip.prod.prop_33; ok }
  "prod/prop_34" in { at.logic.gapt.examples.tip.prod.prop_34; ok }
  "prod/prop_35" in { at.logic.gapt.examples.tip.prod.prop_35; ok }
}
