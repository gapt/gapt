...
object isaplanner09 extends TacticsProof {
  ...
  val proof2 = new AnalyticInductionProver( aipOptions ) solve ( sequent, "goal", List( hov"i:Nat", hov"j:Nat" ) )
  val proof3 = new AnalyticInductionProver( aipOptions ) solve ( bench )
}
