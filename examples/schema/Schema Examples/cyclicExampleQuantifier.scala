...
object cyclicExampleQuantifier extends TacticsProof {
  ...
  val esPhi = Sequent(Seq(), Seq(hof"!y !z (Add2(n,y,z) -> Add1(n,y,z))"))
  ...
  val esPhiBc = Sequent(Seq(), Seq("Suc_0" -> hof"!y !z (Add2(0,y,z) -> Add1(0,y,z))" ))
  val esPhiSc = Sequent(Seq(), Seq("Suc_0" -> hof"!y !z (Add2(s(n),y,z) -> Add1(s(n),y,z))"))
  ...
  val D1Sc = Lemma(esD1Sc) {
    ...
    //cut("cut", hof"(Add1(n, s(y), z) -> Add1(s(n),y,z) )")
    forget("Suc_0")
    ref("d1")
