...
object VeryWeakLexicoPHPSchema extends TacticsProof {
  ...
  val omegaBc = Lemma( esOmegaBc ) {
    cut( "cut", hof"?x ?y ( (E(0,f(x,y)) & E(0,f(suc(x),suc(y)))) | (E(0,f(x,suc(y))) & E(0,f(suc(x),suc(y)))) | (E(0,f(suc(x),y)) & E(0,f(suc(x),suc(y)))) ) | !x !y (LE(f(x,y),0) & LE(f(x,suc(y)),0) & LE(f(suc(x),y),0))" )
    forget( "Suc_0" )
    orR
    allR( fov"a" )
    allR( fov"b" )
  ...
  val omegaSc = Lemma( esOmegaSc ) {
    cut( "cut", hof"?x ?y ( (E(s(n),f(x,y)) & E(s(n),f(suc(x),suc(y)))) | (E(s(n),f(x,suc(y))) & E(s(n),f(suc(x),suc(y)))) | (E(s(n),f(suc(x),y)) & E(s(n),f(suc(x),suc(y)))) ) | !x !y (LE(f(x,y),s(n)) & LE(f(x,suc(y)),s(n)) & LE(f(suc(x),y),s(n)))" )
    forget( "Suc_0" )
    orR
    allR( fov"a" )
    allR( fov"b" )
  ...
  val phiSc = Lemma( esPhiSc ) {
    cut( "cut", hof"?x ?y ( (E(n,f(x,y)) & E(n,f(suc(x),suc(y)))) | (E(n,f(x,suc(y))) & E(n,f(suc(x),suc(y)))) | (E(n,f(suc(x),y)) & E(n,f(suc(x),suc(y)))) ) | !x !y (LE(f(x,y),n) & LE(f(x,suc(y)),n) & LE(f(suc(x),y),n))" )
    orR
    orL
    exL( fov"a" )
    exL( fov"b" )
