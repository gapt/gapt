...
object FactorialFunctionEqualityExampleProof extends ProofSequence {
    ...
    case 0 =>
      ...
      WeakeningLeftMacroRule(
        ...
        List(
          ...
          symm_axiom,
          refl_axiom.getAxiom,
          compat_mul_axiom.getAxiom,
          assoc_mul_axiom.getAxiom,
          g_compat_2.getAxiom,
          mul_neutral_axiom.getAxiom,
          mul_neutral_axiom_2.getAxiom
        )
      )
  ...
  def induction_steps(n: Int): LKProof = {
    ...
    // add axioms
    val all_axioms = List[FOLFormula](
      f_ax_1,
      f_ax_2,
      g_ax_1.getAxiom,
      g_ax_2,
