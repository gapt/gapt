...
class EtaExpansionTest extends SpecificationWithJUnit {
  ...
  "EtaExpansion" should {
    "expand correctly the lambda expressions f : (i->i) to lambda x. f(x)" in {
      etaExpansion.EtaExpand(f)(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (Abs(x,App(f,x)))
...
//      etaExpansion.EtaExpand(g3) must beEqualTo (Abs(y,Abs(x, App(g3,x))))
//      println("\n\ntype = "+g5.exptype.toString)
//      println("\n\neta : "+EtaExpand(App(g3,x))(disAllowedVars = EtaExpand.disAllowedVars).toString1+"\n\n")
      EtaExpand(App(g3,x))(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (Abs(y, AppN(g3, x.asInstanceOf[LambdaExpression]::y.asInstanceOf[LambdaExpression]::Nil)))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
...
//      println("\n\neta : "+EtaExpand(g3)(disAllowedVars = EtaExpand.disAllowedVars).toString1+"\n\n")
      EtaExpand(g3)(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (AbsN(x::y::Nil, AppN(g3,x::y::Nil)))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
//      println("\n\neta : "+etaExpansion.EtaExpand(g5).toString1+"\n\n")
//      0 must beEqualTo (0)
    }
...
//      println("\n\neta : "+EtaExpand(App(g3, AppN(g3,x::y::Nil)))(disAllowedVars = EtaExpand.disAllowedVars).toString1+"\n\n")
      EtaExpand(App(g3, AppN(g3,x::y::Nil)))(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (Abs(z, AppN(g3, AppN(g3, x::y::Nil)::z::Nil)))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
//      println("\n\neta : "+etaExpansion.EtaExpand(g5).toString1+"\n\n")
//      0 must beEqualTo (0)
    }
...
//      println("\n\neta : "+EtaExpand(App(g6,f))(EtaExpand.disAllowedVars).toStringSimple+"\n\n")
      EtaExpand(App(g6,f))(EtaExpand.disAllowedVars) must beEqualTo (Abs(z,App(App(g6, Abs(x,App(f, x))), z)))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
//      println("\n\neta : "+etaExpansion.EtaExpand(g5).toString1+"\n\n")
//      0 must beEqualTo (0)
    }
...
//      println("\n\neta : "+EtaExpand(g6)(disAllowedVars = EtaExpand.disAllowedVars).toString1+"\n\n")
      EtaExpand(g6)(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (AbsN(f::y::Nil, AppN(g6, Abs(z,App(f,z))::y::Nil)))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
//      println("\n\neta : "+etaExpansion.EtaExpand(g5).toString1+"\n\n")
//      0 must beEqualTo (0)
    }
...
//      println("\n\neta : "+EtaExpand(Abs(x,App(g3,x)))(disAllowedVars = EtaExpand.disAllowedVars).toString1+"\n\n")
      ...
      EtaExpand(g3)(disAllowedVars = EtaExpand.disAllowedVars) must beEqualTo (v2)// (EtaExpand(f2)(disAllowedVars = EtaExpand.disAllowedVars))
//      println("\n\neta : "+etaExpansion.EtaExpand(g4).toString1+"\n\n")
//      println("\n\neta : "+etaExpansion.EtaExpand(g5).toString1+"\n\n")
//      0 must beEqualTo (0)
    }
